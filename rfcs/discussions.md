...
import { paymentTokens, bankingTokens } from '@klear/klear360/tokens';

overrideTokens()

<Klear360Provider tokens={payment}>
  <MyApp/>
</Klear360Provider>
...
// web
import DisplayXLarge from '@klear/klear360/components'
<DisplayXLarge/>
...
```jsx
import {myThemeTokens, Klear360ThemeProvider} from 'design-system';

<Klear360ThemeProvider theme={myThemeTokens}>
  <MyApp/>
</Klear360ThemeProvider>
```
...
```jsx
import {myTheme, Klear360ThemeProvider} from 'design-system';

<Klear360ThemeProvider theme={myTheme}>
  <MyApp/>
</Klear360ThemeProvider>
```
