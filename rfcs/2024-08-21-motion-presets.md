...
```jsx
import { Fade, Card, CardBody } from '@klear/components/klear360';

<Fade isVisible={showCard}>
  <Card>
    <CardBody>{/* Klear360 Card */}</CardBody>
  </Card>
</Fade>;
```
...
You can check our detailed design proposal on [Motion Refresh](https://docs.google.com/document/d/1Vj2E0v2IdLSHuJNRrmX7X-BFSqGpXMFU0jj7LLfoZGk/edit?usp=sharing) (Only accessible to Klear Employees)
...
```jsx
import { Fade } from '@klear/klear360/components';
...
```jsx
import { Slide } from '@klear/klear360/components';
...
```jsx
import { Move } from '@klear/klear360/components';
...
```jsx
import { Scale } from '@klear/klear360/components';
...
import { Heading } from '@klear/klear360/components';
...
#### 3. Exposing `morph` Function from Klear360

```jsx
import { Heading, morph } from '@klear/klear360/components';
...
- Allows presetting animation properties on klear360
...
When we wrap a certain component in AnimateInteractions wrapper from klear360, we can animate the children component on interactions of the parent component.
...
- [Stagger Animations POC](https://codesandbox.io/p/sandbox/framer-motion-side-menu-forked-3flyxv)
- [Motion React Layout Animations with Klear360 Components](https://stackblitz.com/edit/framer-motion-klear360-poc?file=App.tsx,Logger.tsx)
...
We'll be using the reduced bundle size version of motion core `m` internally for presets to ensure Klear360 uses minimal bundle size.
...
- Interactive documentation will be added on klear360.klear.com explaining how to use each preset
...
- ## Should motion components be imported from `@klear/klear360/components` like other components or `@klear/klear360/motion`
