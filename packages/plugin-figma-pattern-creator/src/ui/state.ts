...
export const optSupportingElements = document.getElementById(
  'opt_supportingElements',
...
export const optSupportingElement = document.getElementById(
  'opt_supportingElement',
) as HTMLSelectElement | null;
export const optColumnTypeDashboard = document.getElementById(
  'opt_columnType_dashboard',
) as HTMLSelectElement;
