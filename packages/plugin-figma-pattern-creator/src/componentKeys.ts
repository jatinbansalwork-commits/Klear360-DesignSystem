    ...
    variantsByPlatform: {
      desktop: {
        ...
        'stepType=Multiple|viewType=Medium Modal|columnType=Full Width|stepperType=StepGroup|content=Default':
          'de33b294726c3ce5513f3198f93f433c3b6f7acb',
...
export function getPatternsByPlatform(platform: Platform): UIPattern[] {
  return DEFAULT_UI_PATTERNS.filter((pattern) => !pattern.disabledOn?.includes(platform));
}
