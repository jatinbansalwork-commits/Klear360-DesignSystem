...
This guide provides step-by-step instructions on how to properly install and effectively utilize KlearCanvas.

## Installation

The plugin is published on Figma private for Klear employees for now. If you are a Klear employee, you can install the plugin from [here](https://www.figma.com/community/plugin/1200806396995792369/KlearCanvas).

If you are not a Klear employee, you can download and build the project locally.
...
To run the plugin, click on the "Plugins" menu and then click on "KlearCanvas" and then click on "Run".
...
Tag @Burhan on #design-system on the Klear Slack workspace.
