...
KlearCanvas is a Figma plugin that generates code for the Klear360 design system.
...
- Ask designers to always use Klear360 components in Figma
...
Create a new GitHub issue or tag @Burhan on #design-system on the Klear Slack workspace.
