...
export const textDefaultValues: Klear360Props = {
...
export const titleDefaultValues: Klear360Props = {
...
export const headingDefaultValues: Klear360Props = {
...
export const codeDefaultValues: Klear360Props = {
  size: { value: 'small', type: 'string' },
};
