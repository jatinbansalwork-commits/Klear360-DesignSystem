import { KLEAR360_IMPORT_PATH } from '../constants/paths';
...
export const klear360Imports = (imports: string[]): Record<string, string[]> => ({
  [KLEAR360_IMPORT_PATH]: imports.filter((i) => !!i),
});
