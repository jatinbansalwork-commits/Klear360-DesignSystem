...
import type { Klear360HelperProps, Klear360Props, JSXValue } from '~/code/types/Klear360';
...
export const attributes = (props: Klear360Props): string => {
...
export const generateHelperCode = (props: Klear360HelperProps): string => {
  return Object.entries(props)
