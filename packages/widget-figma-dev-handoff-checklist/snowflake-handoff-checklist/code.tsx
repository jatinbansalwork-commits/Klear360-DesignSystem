    ...
    >
      ...
      <AutoLayout direction="vertical" spacing={4} width="fill-parent">
        ...
        <AutoLayout direction="vertical" spacing={4} width="fill-parent">
          ...
          <Checkbox
            id="hygiene5"
            optionText="Designs match Klear's design language"
            onCheckboxClick={updateChecklist}
          />
          <Checkbox
            id="hygiene6"
      ...
      <AutoLayout direction="vertical" spacing={4} width="fill-parent">
        ...
        <AutoLayout direction="vertical" spacing={4} width="fill-parent">
          <Checkbox
            id="rev1"
            optionText="Component reviewed by Klear360 designers/advocates"
            onCheckboxClick={updateChecklist}
          />
          <Checkbox
            id="rev2"
            optionText="Component added to Klear360 Snowflake file"
            onCheckboxClick={updateChecklist}
          />
        </AutoLayout>
      </AutoLayout>
