...
Core utilities and shared functionality for Klear360 Design System.

## Installation

```bash
npm install @klear/klear360-core
# or
yarn add @klear/klear360-core
```
...
```ts
import { colors, spacing, makeBezier, cloneDeep } from '@klear/klear360-core';
```
...
```ts
// Import tokens
import { colors, spacing, typography } from '@klear/klear360-core/tokens';

// Import utilities
import { makeBezier, cloneDeep, isEmpty } from '@klear/klear360-core/utils';
```
