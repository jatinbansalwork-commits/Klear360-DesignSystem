...
import { depsExternalPlugin } from '../klear360/dependencies-external-plugin.mjs';
...
// package.json; a library should let consumers decide, mirroring how `@klear/klear360`
...
const config = () => {
  ...
  const styles = { styles: 'src/styles/index.js' };
