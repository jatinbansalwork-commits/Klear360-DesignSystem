    ...
    surface: {
      background: {
        ...
        primary: {
          ...
          // match klear360Theme's onDark structure. The neutral theme only
        ...
        // klear360Theme's onDark structure. Only onLight carries the real
      ...
      background: {
        ...
        sequential: {
          ...
          gray: {
            ...
            // inherited from klear360Theme.ts and should be fixed when the color
...
export default klear360NeutralTheme;
