...
import { klear360Theme } from '../index';
...
describe('createTheme', () => {
  ...
  it('applies optional borderRadius overrides', () => {
    ...
    expect(theme.border.radius.small).toBe(klear360Theme.border.radius.small);
  });
  ...
  it('applies fontFamily and fontSizeScaleFactor on both platforms', () => {
    ...
    expect(theme.typography.onDesktop.fonts.size[200]).toBe(
      Math.round(klear360Theme.typography.onDesktop.fonts.size[200] * 1.1),
    );
  });
