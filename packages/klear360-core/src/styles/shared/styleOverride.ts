/**
 * Per-slot classname overrides merged onto Klear360 components (provider config + instance prop).
 *
 ...
 * classes beat `@layer klear360` pseudo-state rules. Filled primary "stroke" is inset shadow, not
