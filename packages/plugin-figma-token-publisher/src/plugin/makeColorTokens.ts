...
import { opacity as opacityTokens } from '../../../klear360/src/tokens/global/opacity';
...
const THEME_TOKENS_COLLECTION = 'Klear360 Theme Tokens';

const GLOBAL_TOKENS_COLLECTION = '_global-tokens';

// Figma modes are named `<figmaThemePrefix><separator><scheme>` (eg: klear360/onLight,
// klear360Neutral - onDark). This maps the Figma theme prefix to the corresponding code theme name.
const FIGMA_MODE_THEME_MAP: Record<string, string> = {
  klear360: 'klear360Theme',
  klear360Neutral: 'klear360NeutralTheme',
};
 ...
 * themselves contain the separator (eg: `klear360-neutral/onLight`).
 */
const parseModeName = (
  modeName: string,
