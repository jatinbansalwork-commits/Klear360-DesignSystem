...
> Should be used only with Klear360's [Motion duration & delay tokens](?path=/story/tokens-motion--docs)

> Motion's easing tokens do not require any convertion to platform specific units. They can be used as is.

> You can read more about Klear360's these tokens at [Klear360's Motion RFC](https://github.com/klear/klear360/blob/master/rfcs/2022-03-22-motion-rfc.md)
