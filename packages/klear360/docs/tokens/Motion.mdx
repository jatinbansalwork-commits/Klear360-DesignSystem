...
1. Ensure you've followed all the steps under ["Guides/Usage"](https://klear360.klear.com/?path=/docs/guides-how-to-use--docs) to setup your theme with `<Klear360Provider>`
...
```jsx
import styled from 'styled-components';
import { makeMotionTime } from '@klear/klear360/utils';
