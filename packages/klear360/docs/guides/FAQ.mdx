...
/>`}
            ...
            <Text marginTop="spacing.3">In Storybook, this is already configured for testing Klear360 components. For production apps, add this to your main HTML file.</Text>
          </Text>
        }
      />
      <AccordionItem
        ...
        description={
          <Text>
            This error is caused because ResizeObserver is used by Klear360 but has no global
            ...
            <Link href="https://github.com/klear/klear360/issues/1367" target="_blank">
              GitHub issue here
            </Link>
          </Text>
        }
