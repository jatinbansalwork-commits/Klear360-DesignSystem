...
// and the app-level `Klear360BottomSheetPortal` host declared in `Klear360Provider.native`.
...
// `Klear360BottomSheetPortal` host and their teleported content is silently dropped —
