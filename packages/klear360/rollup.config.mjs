...
const config = () => {
  ...
  const klear360Coverage = 'src/utils/klear360Coverage.ts';
  if (framework === 'REACT') {
    return [
      getWebConfig(components),
      getWebConfig(tokens),
      getWebConfig(utils),
      getKlear360CoverageConfig(klear360Coverage),
