...
namespace Platform {
  ...
  /**
   * While working on klear360, Platform.Select<> type unions both web & native types.
   *
   * We need the union of both types because while working on klear360 we don't know if a file is meant to be a `native` module or `web` module,
