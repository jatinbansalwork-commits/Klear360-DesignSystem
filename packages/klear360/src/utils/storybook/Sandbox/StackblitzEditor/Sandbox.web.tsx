...
const useStackblitzSetup = ({
  ...
  const getStackblitzProject = React.useCallback(
    (lockFileContent?: string): Project => {
      return {
        title: 'Klear360 Example by Klear',
        description: "Example of Klear's Design System, Klear360",
        template: 'node',
        files: {
          '.vscode/settings.json': JSON.stringify(
            {
              'editor.fontFamily': 'Roboto Mono, ui-monospace, Monaco, Consolas, monospace',
              'editor.fontSize': 13,
              'editor.lineHeight': 2,
