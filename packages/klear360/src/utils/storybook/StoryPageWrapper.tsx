      ...
      <WithGlobalStyles>
        ...
        <Box paddingBottom="spacing.4" display="flex" gap="spacing.4" marginBottom="spacing.6">
          {componentMetaInfo?.frameworks.react?.releasedIn ? (
            <Button
              href={`https://github.com/jatinbansalwork-commits/Klearnow.ai/releases/tag/%40klear%2Fklear360%40${componentMetaInfo.frameworks.react.releasedIn}`}
              variant="tertiary"
        ...
        {props.imports === '' ? null : (
          <>
            ...
            <SandboxHighlighter showLineNumbers={false} showTabs={false}>
              {props.imports
                ? props.imports
                : `import { ${props.componentName} } from '@klear/klear360/components';\nimport type { ${props.componentName}Props } from '@klear/klear360/components';`}
            </SandboxHighlighter>
            <br />
            <br />
          </>
