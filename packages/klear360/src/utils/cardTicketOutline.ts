/**
 * Keep in sync with packages/klear360-core/src/utils/cardTicketOutline.ts
 * (klear360 does not depend on klear360-core yet).
 * TODO: import from @klear/klear360-core
 *
