...
const schema = {
  components: [
    ...
    },
    {
      component: 'TEXT',
      content:
        '### Features\n\n- **Bold text** and *italic text* support\n- `Inline code` and code blocks\n- [Links](https://klear.com) to external resources\n- Ordered and unordered lists',
    },
    {
      component: 'TEXT',
      content:
            ...
            [
              ...
              },
              {
                ...
                action: {
                  ...
                  data: {
                    url: 'https://dashboard.klear.com/payments/pay_NxGT5fK8mZ2abc',
                  },
                },
              },
            ],
            [
              ...
              },
              {
                ...
                action: {
                  ...
                  eventName: 'link_click',
                  data: {
                    url: 'https://dashboard.klear.com/payments/pay_MwFS4eJ7lY1xyz',
                  },
                },
              },
            ],
            [
              ...
              },
              {
                ...
                action: {
                  ...
                  eventName: 'link_click',
                  data: {
                    url: 'https://dashboard.klear.com/payments/pay_LvER3dI6kX0def',
                  },
                },
              },
            ],
            [
              ...
              },
              {
                ...
                action: {
                  ...
                  eventName: 'link_click',
                  data: {
                    url: 'https://dashboard.klear.com/payments/pay_KuDQ2cH5jW9ghi',
                  },
                },
              },
            ],
              ...
              children: [
                ...
                },
                {
                  ...
                  action: {
                    type: 'CLICK',
                    eventName: 'link_click',
                    data: { url: 'https://klear.io/klear/8nMpkJZ' },
                  },
                },
              ],
            },
...
TextString.args = {
  content: [
    ...
    '',
    'Here is a [hyperlink](https://klear.com) inside a sentence.',
    '',
    '### Unordered List',
    '',
    '- First item',
