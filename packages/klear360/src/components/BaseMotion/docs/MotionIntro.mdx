...
<Move>
  <Box>
    <Display>Introduction to Motion Presets at Klear</Display>

    [Motion Presets RFC](https://github.com/klear/klear360/blob/master/rfcs/2024-08-21-motion-presets.md)
    ...
    You can learn more about each preset by checking individual documentation from storybook's sidebar. Klear employees can reach out to us on #design-system channel for any help. Checkout [Recipes](/?path=/story/motion-recipes) for more usecase level examples of motion.
  </Box>
</Move>
