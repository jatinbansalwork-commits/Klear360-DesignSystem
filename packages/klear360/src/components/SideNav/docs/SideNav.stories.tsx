...
import { KlearLinesSvg, KlearLogo } from './KlearLogo';
...
import { Switch as Klear360Switch } from '~components/Switch';
      ...
      >
        <SideNavBody>
          <SideNavSection>
            ...
            <NavItem title="How to get promoted to CTO in Klear?" href="/chat/promotion" />
            <NavItem title="Will Maya take over AI's job?" href="/chat/maya-ai" />
            ...
            <NavItem title="Can Klear360 MCP fix my life?" href="/chat/mcp" />
          </SideNavSection>
        </SideNavBody>
      </SideNav>
