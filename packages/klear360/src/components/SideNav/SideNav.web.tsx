 ...
 * #### Usage
 *
 * SideNav requires handling active state with React Router, Checkout Usage with React Router v6 at - [SideNav Documentation](https://klear360.klear.com/?path=/docs/components-sidenav--docs)
 *
 */
const _SideNav = (
  {
