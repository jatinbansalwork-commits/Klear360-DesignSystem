...
- [Figma - SelectableCard](https://www.figma.com/design/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?node-id=105706-19869&p=f&m=dev)
...
- **Severely Limited Content**: Prop-based API (title, subtitle, leading) cannot handle:
  ...
  - Klear-specific designs (transaction details, payment methods)
...
### **Consistent with Klear360 Patterns**
...
- **Composable**: Easy to combine with other Klear360 components
