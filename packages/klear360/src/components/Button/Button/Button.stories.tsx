...
import {
  getKlear360CommonEventArgTypes,
...
const Page = (): ReactElement => {
  return (
    <StoryPageWrapper
      ...
      figmaURL="https://www.figma.com/proto/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?type=design&node-id=74881-74603&t=2pKzbmnd3phWhn1M-1&scaling=min-zoom&page-id=614%3A1&mode=design"
    >
      <Title>Usage</Title>
      <Sandbox showConsole>
        {`
      ...
      <Description markdown="`icon` prop accepts an `IconComponent` of Klear360 which should be used as:" />
      <code>{`import { Button, CreditCardIcon } from '@klear/klear360/components'; \n\n\u003CButton icon={CreditCardIcon}>Pay Now\u003C/Button>`}</code>
      <br />
      <br />
    </StoryPageWrapper>
  );
...
export const ButtonRef: StoryFn<typeof ButtonComponent> = () => {
  const buttonRef = React.useRef<Klear360ElementRef>(null);
