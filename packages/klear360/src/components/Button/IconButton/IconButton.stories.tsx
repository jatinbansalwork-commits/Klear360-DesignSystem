...
import { getKlear360CommonEventArgTypes } from '~components/Box/BaseBox/storybookArgTypes';
...
const Page = (): ReactElement => {
  return (
    <StoryPageWrapper
      ...
      figmaURL="https://www.figma.com/proto/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?type=design&node-id=71108-309592&t=ozxGdqCDqI9hRYY8-1&scaling=min-zoom&page-id=614%3A1&mode=design"
    >
      <Title>Usage</Title>
      <Sandbox showConsole>
        {`
