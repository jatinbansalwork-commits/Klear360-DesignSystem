...
import type { Klear360ElementRef, DataAnalyticsAttribute } from '~utils/types';
 ...
 */
const _IconButton: React.ForwardRefRenderFunction<Klear360ElementRef, IconButtonProps> = (
  {
    icon,
    onClick,
    size = 'medium',
