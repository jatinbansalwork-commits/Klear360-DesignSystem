...
[Figma Link](https://www.figma.com/file/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?type=design&node-id=81454-67196&mode=design&t=6sCjPO2iUqIMuPHT-0) to all variants of the Breadcrumb component
...
```ts
type BreadcrumbProps = StyledPropsKlear360 & {
  /**
...
import { Breadcrumb, BreadcrumbItem } from "@klear/klear360/components";
import {
  useHref,
  useLinkClickHandler,
