 ...
 * Modelled after KlearGlassMount — create it with a parent element, call setOrigin()
 * to update the gradient origin reactively, and dispose() to clean up.
 */

import type { FullscreenQuadBuffers } from '../KlearGlass/webgl-utils';
import { createProgram, setupFullscreenQuad } from '../KlearGlass/webgl-utils';
