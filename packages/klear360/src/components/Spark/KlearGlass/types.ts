 ...
 * KlearGlass Types
 *
 * TypeScript types for the KlearGlass WebGL shader component.
...
// DISPLACEMENT CONFIG
// ============================================
type KlearGlassDisplacementConfig = {
...
// ============================================
type KlearGlassCenterElementConfig = {
...
// ============================================
type KlearGlassColorCorrectionConfig = {
...
// ============================================
type KlearGlassBackgroundConfig = {
...
// ============================================
type KlearGlassCycleAnimConfig = {
...
// COMBINED CONFIG
// ============================================
type KlearGlassConfig = KlearGlassColoramaConfig &
  KlearGlassDisplacementConfig &
  KlearGlassCenterElementConfig &
  KlearGlassColorCorrectionConfig &
  KlearGlassCanvasConfig &
  KlearGlassZoomPanConfig &
  KlearGlassBackgroundConfig &
  KlearGlassEffectToggles &
  KlearGlassLightConfig &
  KlearGlassPlaybackConfig &
  KlearGlassCycleAnimConfig;

// ============================================
// ASSETS
// ============================================
type KlearGlassAssets = {
...
// ============================================
type KlearGlassPresetDefinition = Partial<KlearGlassConfig> & Partial<KlearGlassAssets>;

// ============================================
// UNIFORM TYPES (for internal WebGL mapping)
// ============================================
type KlearGlassUniforms = {
...
// COMPONENT PROPS
// ============================================
type KlearGlassProps = KlearGlassConfig & {
