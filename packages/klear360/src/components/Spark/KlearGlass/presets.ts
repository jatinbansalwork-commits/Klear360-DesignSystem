import type { KlearGlassConfig, KlearGlassPresetDefinition } from './types';

// ============================================
// DEFAULT CONFIG VALUES
// ============================================
const DEFAULT_CONFIG: Required<KlearGlassConfig> = {
  // Input Phase
  inputMin: 0.0,
  inputMax: 1.0,
  // Modify Phase
...
// PRESETS
// ============================================
export type KlearGlassPreset = 'default' | 'zoomed' | 'bottomWave' | 'rippleWave' | 'circleSlideUp';

/**
 * Get preset definitions with dynamic CDN path support.
 * Asset URLs in presets will use the provided assetsPath.
 */
const getPresets = (assetsPath: string): Record<KlearGlassPreset, KlearGlassPresetDefinition> => ({
...
/**
 * Dark-mode overlay, applied on top of the resolved preset whenever Klear360's
...
const getDarkOverlay = (
  assetsPath: string,
  config: Pick<KlearGlassConfig, 'ccMidtoneGamma' | 'ccGamma'>,
