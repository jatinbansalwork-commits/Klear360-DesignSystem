 ...
 * KlearGlass render settings. Uses a layered heuristic approach:
 *
...
export type RenderSettings = {
  /** Max rendered pixel count passed to KlearGlassMount */
  maxPixelCount: number;
  /** Minimum device pixel ratio passed to KlearGlassMount */
 ...
 *
 * const mount = new KlearGlassMount(
 *   el,
 *   assets,
 *   {},
 *   0,
