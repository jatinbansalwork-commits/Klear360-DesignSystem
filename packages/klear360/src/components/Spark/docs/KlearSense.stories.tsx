...
import type { KlearSenseProps } from '../KlearGlass/index';
import {
  KlearSense as KlearSenseComponent,
  KlearSenseGradient,
...
export default {
  title: 'Components/KlearSense',
  component: KlearSenseComponent,
  args: {},
  tags: ['autodocs'],
  parameters: {
    layout: 'fullscreen',
...
} as Meta<KlearSenseProps>;

const KlearSenseTemplate: StoryFn<typeof KlearSenseComponent> = (args) => {
  return (
    <Box width="100%" height="100vh">
      <KlearSenseComponent preset={args.preset} {...args} />
    </Box>
  );
};

export const Default = KlearSenseTemplate.bind({});

/**
 * KlearSense follows Klear360's color scheme — there is no dark-mode prop. When the
 * surrounding `Klear360Provider` is in `dark`, every preset automatically picks up its
 ...
 */
export const ColorSchemeAware: StoryFn<typeof KlearSenseComponent> = () => {
  ...
  return (
    <Box display="flex" flexDirection="column" height="100vh" gap="spacing.4">
      ...
      <Box flex="1" position="relative">
        <KlearSenseComponent width="100%" height="100%" preset="default" />
      </Box>
    </Box>
  );
};
...
export const DefaultPaused = KlearSenseTemplate.bind({});
DefaultPaused.args = {
  paused: true,
  startTime: 8,
...
export const Zoomed: StoryFn<typeof KlearSenseComponent> = () => {
  return (
    <Box position="relative" display="flex" alignItems="center" height="400px" width="100%">
      <Box
        ...
        zIndex={0}
      >
        <KlearSenseComponent preset="zoomed" width="100%" height="100%" />
      </Box>
...
const BottomWaveTemplate: StoryFn<typeof KlearSenseComponent> = () => {
  return (
    <Box margin="-32px" position="relative" height="100vh">
      {/* KlearSense at the bottom */}
...
const KlearSensePropsTemplate: StoryFn<typeof KlearSenseComponent> = () => {
  return (
...
export const KlearSensePropsExplanation = KlearSensePropsTemplate.bind({});
KlearSensePropsExplanation.storyName = 'KlearSense Props';

const KlearGlassSuccessAnimationTemplate: StoryFn<typeof KlearSenseComponent> = () => {
  const [isLoaded, setIsLoaded] = useState(false);
  const [assetsPreloaded, setAssetsPreloaded] = useState(false);

  useEffect(() => {
    preloadKlearSenseAssets('circleSlideUp')
      .then(() => {
    ...
    <Box display="flex" flexDirection="column" height="100vh">
      ...
      >
        ...
        <Box
          ...
          width="90%"
        >
          {/* Success Icon with KlearGlass animation */}
          ...
          >
            ...
            >
              <Text size="small" textAlign="center" color="surface.text.gray.muted">
                Redirecting to your Klear home in 15 seconds
              </Text>
            </motion.div>
          </motion.div>
        </Box>
...
export const KlearGlassSuccessAnimation = KlearGlassSuccessAnimationTemplate.bind({});
...
const RippleWaveAnimationTemplate: StoryFn<typeof KlearSenseComponent> = () => {
  const [assetsPreloaded, setAssetsPreloaded] = useState(false);
      ...
      <Box display="flex" flexDirection="column" height="100vh">
        ...
        >
          ...
          >
            ...
            >
              <KlearSenseComponent width="100%" height="100%" preset="rippleWave" />
            </motion.div>
          </Box>
          <KlearSenseGradient
            style={{
...
const OnboardingPlaybackControlsTemplate: StoryFn<typeof KlearSenseComponent> = () => {
  const [assetsPreloaded, setAssetsPreloaded] = useState(false);
  const {
    currentPhase,
    setCurrentPhase,
  ...
  useEffect(() => {
    preloadKlearSenseAssets('default')
...
// ---------------------------------------------------------------------------
// KlearSenseGradient Examples
// ---------------------------------------------------------------------------

const KlearSenseGradientBasicTemplate: StoryFn<typeof KlearSenseComponent> = () => {
  ...
  return (
    <Box padding="spacing.8">
      <Heading size="large" marginBottom="spacing.6">
        KlearSenseGradient - Basic Examples
      </Heading>
      <Text marginBottom="spacing.6" color="surface.text.gray.muted">
        KlearSenseGradient renders an animated WebGL gradient clipped to any SVG shape you pass as
      ...
      >
        ...
        <Box display="flex" flexDirection="column" alignItems="center" gap="spacing.3">
          <KlearSenseGradient size={100} viewBox="0 0 24 24" origin={[0.5, 0.5]}>
      ...
      >
        {[40, 60, 80, 120].map((s) => (
          <Box key={s} display="flex" flexDirection="column" alignItems="center" gap="spacing.3">
            <KlearSenseGradient size={s} viewBox="0 0 24 24" origin={[0.5, 0.5]}>
              <path
                d="M3 3H7.5H9.74999L12 12L14.25 3H16.5H21V7.5V9.75L12 12L21 14.25V16.5V21H16.5H14.25L12 12L9.74999 21H7.5H3V16.5V14.25L12 12L3 9.75V7.5V3Z"
                fill="white"
              />
      ...
      <Box display="flex" gap="spacing.6" flexWrap="wrap">
        {origins.map(({ origin, label }) => (
          <Box
            ...
            gap="spacing.3"
          >
            <KlearSenseGradient size={80} viewBox="0 0 24 24" origin={origin}>
              <rect x="2" y="2" width="20" height="20" rx="2" fill="white" />
            </KlearSenseGradient>
...
export const KlearSenseGradientBasic = KlearSenseGradientBasicTemplate.bind({});

const KlearSenseGradientPropsTemplate: StoryFn<typeof KlearSenseComponent> = () => {
  return (
    <Box padding="spacing.8" maxWidth="800px">
      <Heading size="xlarge" marginBottom="spacing.6">
        KlearSenseGradient Props
      </Heading>
...
export const KlearSenseGradientProps = KlearSenseGradientPropsTemplate.bind({});
...
const TweakpanePlaygroundTemplate: StoryFn<typeof KlearSenseComponent> = () => {
...
const LoginPageTemplate: StoryFn<typeof KlearSenseComponent> = () => {
  ...
  return (
    <Box
      ...
      backgroundColor="surface.background.gray.intense"
    >
      {/* Left Panel - KlearSense Gradient */}
      <Box
        flex="1"
        position="relative"
        overflow="hidden"
      ...
      >
        ...
        <Box position="relative" zIndex={1} maxWidth="500px" opacity={0.6}>
          <Heading size="xlarge" color="surface.text.gray.normal" marginBottom="spacing.4">
            Join 8 Million businesses that trust Klear to supercharge their business
          </Heading>
