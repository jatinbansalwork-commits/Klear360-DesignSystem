...
<Box padding="spacing.6">
  <Box gap="spacing.6">
    <Heading size="large">Welcome to Klear360 Example</Heading>
    <Heading variant="subheading">This is an example form built with klear360</Heading>
  </Box>
...
Klear360’s FormGroup pattern will not ship with a built-in validation strategy.
...
1. **Scope Management**
   ...
   - Implementing a robust validation system would essentially make Klear360 a form library
...
3. **Integration Flexibility**
   ...
   - Klear360 components are designed to be flexible and adaptable, capable of consuming validation states from different libraries.
...
Instead, Klear360 will continue to support error handling through existing props on input components, while leaving global error handling to teams based on their specific UX needs.
