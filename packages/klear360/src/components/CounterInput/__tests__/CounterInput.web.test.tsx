...
const getCounterInputFieldWidth = ({
  ...
  const horizontalPadding =
    klear360Theme.spacing[baseInputCounterInputPaddingTokens.left[size]] +
    klear360Theme.spacing[baseInputCounterInputPaddingTokens.right[size]];
...
describe('<CounterInput />', () => {
  ...
  it('should reserve two digits and expand the width for larger values', () => {
    ...
    expect(container1.querySelector('.__klear360-counter-input-number-wrapper')).toHaveStyle({
      flex: 'none',
    ...
    expect(container2.querySelector('.__klear360-counter-input-number-wrapper')).toHaveStyle({
  ...
  it.each(['xsmall', 'large'] as const)(
    ...
    (size) => {
      ...
      expect(container.querySelector('.__klear360-counter-input-number-wrapper')).toHaveStyle({
  ...
  it('should account for minus sign width when value is negative', () => {
    ...
    expect(container3.querySelector('.__klear360-counter-input-number-wrapper')).toHaveStyle({
