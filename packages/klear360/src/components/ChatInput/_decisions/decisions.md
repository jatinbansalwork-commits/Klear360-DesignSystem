...
```jsx
import { ChatInput, ChatInputFilePreview, ChatInputQuote } from '@klear/klear360/components';
...
- Pros
  ...
  - Consumer can use custom components or Klear360 components for previews
...
type ChatInputProps = {
   ...
   */
  onSubmit?: ({ value, fileList }: { value: string; fileList: Klear360FileList }) => void;
   ...
   * Reuses the Klear360File/Klear360FileList types from the FileUpload component.
   */
   ...
   */
  onFileChange?: ({ fileList }: { fileList: Klear360FileList }) => void;

  /**
   * Callback fired when a file is removed from the attachment previews
   */
  onFileRemove?: ({ file }: { file: Klear360File }) => void;
...
> **Note:** `Klear360File` and `Klear360FileList` are reused from the existing [FileUpload component](../../FileUpload/types.ts). `Klear360File` extends the native `File` interface with `id`, `status`, `uploadPercent`, and `errorText` fields.
...
- Klear360 FileUpload -- [`packages/klear360/src/components/FileUpload`](../../FileUpload/) for `Klear360File`/`Klear360FileList` types and file upload patterns
- Klear360 TextArea -- [`packages/klear360/src/components/Input/TextArea`](../../Input/TextArea/) for textarea input patterns
- Klear360 ChatMessage -- [`packages/klear360/src/components/ChatMessage`](../../ChatMessage/) for existing chat component patterns
