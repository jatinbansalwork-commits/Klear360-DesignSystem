...
> **Note**
>
> Unlike ListView, there aren't enough reasons to create Layout component for DetailedView. More about this is discussed in [pattern-terminology.md](../../ListView/_decisions/pattern-terminology.md)
