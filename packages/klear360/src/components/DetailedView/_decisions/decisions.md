...
Detailed View Pattern is UI pattern in Klear which is used to display detailed information about merchant, some row item from table, or extended information.

## API

> **Note**
>
> Unlike ListView, there aren't enough reasons to create Layout component for DetailedView. More about this is discussed in [pattern-terminology.md](https://github.com/klear/klear360/blob/e58edf015d2062bd51374c5a7024a85adc13f636/packages/klear360/src/components/ListView/_decisions/pattern-terminology.md)
