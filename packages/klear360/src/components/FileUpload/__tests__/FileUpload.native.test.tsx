...
import type { Klear360File } from '../types';
...
describe('<FileUpload /> (native)', () => {
  ...
  it('should warn in __DEV__ when unsupported props are passed', () => {
    ...
    expect(warnSpy).toHaveBeenCalledWith(
      expect.stringContaining('[Klear360: FileUpload]: maxCount has no effect on React Native'),
    );
    expect(warnSpy).toHaveBeenCalledWith(
      expect.stringContaining('[Klear360: FileUpload]: maxSize has no effect on React Native'),
    );
    expect(warnSpy).toHaveBeenCalledWith(
      expect.stringContaining('[Klear360: FileUpload]: accept has no effect on React Native'),
    );
    expect(warnSpy).toHaveBeenCalledWith(
      expect.stringContaining('[Klear360: FileUpload]: onDrop has no effect on React Native'),
    );
    expect(warnSpy).toHaveBeenCalledWith(
      expect.stringContaining('[Klear360: FileUpload]: labelPosition="left" is not supported'),
    );
