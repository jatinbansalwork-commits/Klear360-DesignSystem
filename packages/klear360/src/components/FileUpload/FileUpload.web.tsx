...
const _FileUpload: React.ForwardRefRenderFunction<Klear360ElementRef, FileUploadProps> = (
  ...
  const handleFilesChange = useCallback((inputFiles: Klear360FileList) => {
  ...
  const validateFiles = (inputFiles: Klear360FileList, allFiles: Klear360FileList): boolean => {
 ...
 *  ---
 *
 * Checkout {@link https://klear360.klear.com/?path=/docs/components-fileupload FileUpload Documentation}
 *
 */
