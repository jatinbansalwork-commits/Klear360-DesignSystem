...
[Figma Link](https://www.figma.com/file/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?type=design&node-id=78150%3A2625&mode=design&t=bKQvPInRmAoeAAFV-1) to all variants of the `FileUpload` component.
...
```ts
// Platform-split: on web, Klear360File extends the DOM File API (see klear360File.web.ts).
// On React Native, Klear360File is a plain object (see klear360File.ts) because File/Blob
// globals are unavailable. Check the File type from MDN for web details:
// https://developer.mozilla.org/en-US/docs/Web/API/File
interface Klear360File extends File {
  /**
...
type Klear360FileList = Klear360File[];
...
import { Box, FileUpload } from '@klear/klear360/components';
