...
- [Figma - Menu](https://www.figma.com/design/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?node-id=90082-41948&m=dev)
...
```ts
// Follows the standard header, footer types of Klear360 like DropdownHeader, ModalHeader, etc
