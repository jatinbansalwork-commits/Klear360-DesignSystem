...
- [Figma - InfoGroup](https://www.figma.com/design/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?node-id=99000-73547&p=f&m=dev)
...
<InfoGroup itemOrientation="horizontal" size="medium">
  <InfoItem>
    ...
    <InfoItemValue trailing={CheckIcon}>Alex Rivera</InfoItemValue>
  </InfoItem>
  <Divider />
  <InfoItem>
...
- Cannot compose with other Klear360 components easily
...
<InfoGroup itemOrientation="horizontal" size="medium">
  <InfoItem>
    ...
    <InfoItemValue>Alex Rivera</InfoItemValue>
  </InfoItem>
  <InfoItem>
...
<InfoGroup itemOrientation="horizontal" size="large">
  <InfoItem>
    <InfoItemKey
      leading={<Avatar size="medium" name="Alex Rivera" />}
      helpText="Account holder profile"
    >
      Account Holder
    </InfoItemKey>
    <InfoItemValue trailing={ExternalLinkIcon}>Alex Rivera</InfoItemValue>
  </InfoItem>
  <InfoItem>
...
<InfoGroup itemOrientation="vertical" size="large">
  <InfoItem>
    ...
    <InfoItemValue leading={CheckIcon}>Alex Rivera</InfoItemValue>
  </InfoItem>
  <InfoItem>
...
Using Klear360 components and custom layouts for complex value rendering.
