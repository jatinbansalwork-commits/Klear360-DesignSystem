...
const Page = (): React.ReactElement => {
  return (
    ...
    >
      ...
      <Sandbox>
        {`
        import { InfoGroup, InfoItem, InfoItemKey, InfoItemValue, UserIcon } from '@klear/klear360/components';
...
export const WithAvatars: StoryFn<typeof InfoGroup> = (args) => {
  return (
    <InfoGroup {...args}>
      <InfoItem>
        <InfoItemKey
          leading={<Avatar size={args.size} name="Alex Rivera" />}
...
export const WithInteractiveItems: StoryFn<typeof InfoGroup> = (args) => {
  ...
  const [accountHolder, setAccountHolder] = React.useState('Alex Rivera');
