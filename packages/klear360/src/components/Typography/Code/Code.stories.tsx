...
const Page = (): ReactElement => {
  return (
    ...
    >
      ...
      <Sandbox>
        {`
          import { Code, Text } from '@klear/klear360/components';
...
export const ParagraphUse = (): React.ReactElement => {
  return isReactNative() ? (
    <>
      ...
      <BaseBox display="flex" flexDirection="row" alignItems="center" flexWrap="wrap">
        <Text>Klear360 is Super Cool DS </Text>
        <CodeComponent>CODE</CodeComponent>
        <Text> component</Text>
      </BaseBox>
    </>
    ...
    <>
      ...
      <BaseBox>
        <Text>
          Klear360 is Super Cool DS <CodeComponent>CODE</CodeComponent> component
        </Text>
      </BaseBox>
    </>
  );
