...
const Page = (): React.ReactElement => {
  return (
    <StoryPageWrapper
      ...
      figmaURL="https://www.figma.com/proto/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?type=design&node-id=76148-71527&t=Omk4hcIEm7PBLJAr-1&scaling=min-zoom&page-id=18766%3A294914&mode=design"
    >
      <Title>Usage</Title>
        ...
        <ActionListComponent>
          <ActionListSection title="Account">
            <ActionListItem
              title="Profile"
              value="profile"
              leading={<ActionListItemAvatar icon={UserIcon} color="primary" name="Alex Rivera" />}
            />
            <ActionListItem
              title="Credit"
              value="credit"
