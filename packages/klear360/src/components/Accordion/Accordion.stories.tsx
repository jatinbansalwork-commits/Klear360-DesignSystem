...
const Page = (): ReactElement => {
  return (
    <StoryPageWrapper
      ...
      figmaURL="https://www.figma.com/proto/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?type=design&node-id=74858-50167&t=Kp8hYSNEvkkPXfFF-1&mode=design"
    >
      <Title>Usage</Title>
      <Sandbox editorHeight={500}>
        {`
        import { Accordion, AccordionItem, AccordionItemHeader, AccordionItemBody } from '@klear/klear360/components';
...
WithIcons.parameters = {
  docs: {
    description: {
      story:
        'Use the `icon` prop in `AccordionItem` to pass klear360 icons. **Note:** this should not be used with `showNumberPrefix` on `Accordion`.',
    },
  },
};
        ...
        <AccordionItem>
          ...
          <AccordionItemBody>
            <Text color="surface.text.gray.subtle">
              Klear please verify a payment of{' '}
  ...
  return (
    <AccordionComponent {...args}>
      ...
      <AccordionItem
        ...
        description="Use Klear Payouts to send money to bank accounts, UPI IDs, or wallets instantly. You can automate bulk payouts via APIs or manage them from the dashboard."
      />
    </AccordionComponent>
  );
};
