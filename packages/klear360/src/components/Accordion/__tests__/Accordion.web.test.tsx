...
describe('<Accordion />', () => {
  ...
  it('should expand and close in uncontrolled behavior', async () => {
    ...
    const description1 =
      'You can use Klear Route from the Dashboard or using APIs to transfer money to customers. You may also check our docs for detailed instructions.';
    const button2 = 'How can I setup QR Codes?';
    const description2 =
      'Just use Klear. You may also check our docs for detailed instructions. Please use the search functionality to ask your queries.';
...
describe('Deprecated <Accordion />', () => {
  ...
  it('should render data attributes with correct values', () => {
    const { container } = renderWithTheme(
      <Accordion data-analytics-accordion-name="klear-faq">
