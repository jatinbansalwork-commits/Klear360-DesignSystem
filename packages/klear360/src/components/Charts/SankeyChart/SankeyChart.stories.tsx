...
export default {
  ...
  argTypes: {
    ...
    showLabelChip: {
      control: { type: 'boolean' },
      description:
        'When true (default), labels render as Klear360-styled chips with value + percentage. When false, renders the same info (name + value + percentage) as plain SVG text without chip background — cleaner for dense charts or static exports.',
    },
    showPercentage: {
      control: { type: 'boolean' },
      description:
...
const NODE_NAMES: string[][] = [
  ...
  ['Klear', 'PayU', 'Billdesk', 'Stripe', 'CCAvenue', 'PayTM'],
