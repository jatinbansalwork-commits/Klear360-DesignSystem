...
const REFERENCE_BAND_LOWER_CLASS = 'klear360-reference-band-lower';
const REFERENCE_BAND_UPPER_CLASS = 'klear360-reference-band-upper';
// className on the <g> layer that holds the painted band path.
const REFERENCE_BAND_LAYER_CLASS = 'klear360-reference-band-layer';
