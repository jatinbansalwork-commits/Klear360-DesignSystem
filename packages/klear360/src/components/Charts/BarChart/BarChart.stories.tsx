...
const Page = (): React.ReactElement => {
  return (
    <StoryPageWrapper
      ...
      componentDescription="A Bar Chart component built on top of Recharts with Klear360 design system styling."
      figmaURL="https://www.figma.com/design/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?node-id=92678-188719&p=f&m=dev"
