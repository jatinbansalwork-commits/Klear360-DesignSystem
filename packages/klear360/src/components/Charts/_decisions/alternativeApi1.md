...
```ts
// Import statement
import { LineChart } from '@klear/klear360/charts';
...
```tsx
import { BarChart } from '@klear/klear360/charts';
...
```ts
import { PieChart } from '@klear/klear360/charts';
