...
type ChartAreaProps = {
   ...
   *
   * Narrowed to `boolean` (instead of `RechartAreaProps['connectNulls']`) intentionally: Klear360
   * restricts the API surface to a controlled subset so that `connectNullsStyle` — a Klear360-specific
