...
import { Link as Klear360Link } from '~components/Link';
    ...
    <SideNav isOpen={isOpen} onDismiss={onDismiss} position="absolute">
      <SideNavBody>
        ...
        <SideNavSection title="Products" maxVisibleItems={2}>
          <NavLink icon={LayoutIcon} title="Insights" href="/insights" />
...
const searchMenuItems = [
  ...
  { title: 'Insights', icon: LayoutIcon },
          ...
          {isMobile ? (
            ...
            <>
                ...
                <TabNav
                  items={[
                    ...
                    },
                    {
                      href: '/projects',
                      title: 'Projects',
                      icon: { default: LayoutIcon, selected: LayoutIcon },
              ...
              <TopNavActions>
                ...
                <Menu openInteraction="click">
                  <Avatar size="small" name="Maya Chen" />
                  <MenuOverlay>
                    <MenuHeader title="Profile" />
                    <Box display="flex" gap="spacing.4" padding="spacing.4" alignItems="center">
