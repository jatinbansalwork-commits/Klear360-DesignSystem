...
- [Figma - Indicator](https://www.figma.com/file/jubmQL9Z8V7881ayUD95ps/Klear360---Payment-Light?node-id=8224%3A1)
...
However, at the moment we don't have a solid pattern for this usecase to build an API that can support all possible usage _(within Klear360 or outside Klear360 with custom components)_:
