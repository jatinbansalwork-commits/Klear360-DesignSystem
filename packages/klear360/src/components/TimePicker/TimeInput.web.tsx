 ...
 */
const TimeSegment: React.ForwardRefRenderFunction<Klear360ElementRef, TimeSegmentProps> = ({
  segment,
  state,
  isDisabled,
}) => {
 ...
 * - Uses Klear360's BaseInput (as="div") for styling and form integration
 ...
 */
const _TimeInput: React.ForwardRefRenderFunction<Klear360ElementRef, TimePickerInputProps> = (
  {
    timeValue,
    internalTimeValue,
    onChange,
