...
- [Figma - TimePicker](https://www.figma.com/design/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?node-id=110199-7268&p=f&t=aT7zMPeFO88p0TdZ-0)
...
```jsx
import { TimePicker } from '@klear/klear360/components';
...
- We know Mantine v8 upgrade is not straightforward as its major version upgrade(
...
- Mantine v8 Upgrade Constraints - Technical reasons for not upgrading to Mantine v8 right now
- TimePicker Discussion - TimePicker React Aria implementation discussion and POC results

## Integration with the i18n library

We need to figure out how to integrate the time picker with the i18n library,
...
- TimePicker - Mantine Upgrade Exploration

- TimePicker - React Aria Implementation
