...
const _Avatar: React.ForwardRefRenderFunction<Klear360ElementRef, AvatarProps> = (
  {
    name,
    color = 'neutral',
    size = 'medium',
 ...
 *  ---
 *
 * Checkout {@link https://klear360.klear.com/?path=/docs/components-avatar-avatar Avatar Documentation}
 *
 */
