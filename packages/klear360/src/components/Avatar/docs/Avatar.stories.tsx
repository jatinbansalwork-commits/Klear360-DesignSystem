...
const Page = (): React.ReactElement => {
  return (
    ...
    >
      ...
      <Sandbox showConsole>
        {`
        import { Avatar } from '@klear/klear360/components';
...
const InteractiveNonInteractiveTemplate: StoryFn<typeof AvatarComponent> = () => {
  return (
    <Box display="flex" flexDirection="column" gap="spacing.5">
      ...
      <AvatarComponent href="https://klear.com" size="large" />
    ...
    <Box display="flex" flexDirection="column" gap="spacing.8">
      ...
      <Box>
        ...
        <Box display="flex" flexDirection="row" gap="spacing.5">
          <Box display="flex" flexDirection="column" alignItems="center" gap="spacing.2">
            <AvatarComponent variant="circle" size="large" name="Maya Chen" />
            <Text size="small">Circle</Text>
          </Box>
          <Box display="flex" flexDirection="column" alignItems="center" gap="spacing.2">
            <AvatarComponent variant="square" size="large" name="Maya Chen" />
        ...
        <Box display="flex" flexDirection="row" gap="spacing.5" alignItems="flex-end">
          {sizes.map((size) => (
            <Box
              ...
              gap="spacing.2"
            >
              <AvatarComponent variant="circle" size={size} name="Maya Chen" />
        ...
        <Box display="flex" flexDirection="row" gap="spacing.5" alignItems="flex-end">
          {sizes.map((size) => (
            <Box
              ...
              gap="spacing.2"
            >
              <AvatarComponent variant="square" size={size} name="Maya Chen" />
              <Text size="small">{size}</Text>
            </Box>
          ))}
        </Box>
        ...
        <Box display="flex" flexDirection="row" gap="spacing.5" flexWrap="wrap">
          {colors.map((color) => (
            <Box
              ...
              gap="spacing.2"
            >
              <AvatarComponent size="large" color={color} name="Maya Chen" />
      ...
      <Box>
        ...
        <Box display="flex" flexDirection="row" gap="spacing.5">
          ...
          <Box display="flex" flexDirection="column" alignItems="center" gap="spacing.2">
            <AvatarComponent size="large" name="Link" href="https://klear.com" target="_blank" />
          ...
          {sizes.map((size) => (
            <Box key={size} display="flex" flexDirection="row" alignItems="center" gap="spacing.4">
              ...
              <AvatarGroupComponent size={size}>
                <AvatarComponent color="primary" name="Maya Chen" />
                <AvatarComponent color="positive" name="Jordan Hale" />
                <AvatarComponent color="negative" name="Rama Krushna" />
                <AvatarComponent color="information" name="Nitin Kumar" />
                <AvatarComponent color="notice" name="Riley Novak" />
