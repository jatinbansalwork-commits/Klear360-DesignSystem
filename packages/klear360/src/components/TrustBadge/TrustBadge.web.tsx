...
import { KlearTrustIcon } from '~components/Icons';
 ...
 * <TrustBadge label="Klear Verified" />  // custom trust label
 * ```
 */
const _TrustBadge = ({
  variant = 'default',
