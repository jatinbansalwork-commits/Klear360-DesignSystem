...
describe('<Radio />', () => {
  ...
  it('should not render trailing element in horizontal orientation', () => {
    expect(() =>
      ...
      '[Klear360: Radio]: The `trailing` prop is not supported when the parent `RadioGroup` has `orientation="horizontal"`. Remove the `trailing` prop or switch to `orientation="vertical"`.',
    );
  });
