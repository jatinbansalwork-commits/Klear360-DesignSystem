...
- [Figma Link - Radio](https://www.figma.com/file/jubmQL9Z8V7881ayUD95ps/Klear360---Payment-Light?node-id=13133%3A160709)
...
<RadioGroup
  name="developers"
  label="Developers"
  helpText="Pick preferred klear360 developer"
  defaultValue="maya"
>
  <Radio value="maya">Maya</Radio>
  <Radio value="riley">Riley</Radio>
  <Radio value="sam">Sam</Radio>
...
```tsx
const Controlled = () => {
  const [selected, setSelected] = React.useState('jordan');
