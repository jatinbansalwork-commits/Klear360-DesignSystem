...
[Figma Link](https://www.figma.com/file/jubmQL9Z8V7881ayUD95ps/Klear360---Payment-Light?node-id=13227%3A163026) to all variants of the Checkbox component
...
```tsx
// Label text
<Checkbox>is klear360 awesome?</Checkbox>
// Helper text
<Checkbox helpText="Hint: yes">is klear360 awesome?</Checkbox>
// uncontrolled
<Checkbox defaultChecked={true}>is klear360 awesome?</Checkbox>
// controlled
<Checkbox isChecked={true | false} onChange={({ isChecked }) => {}}>is klear360 awesome?</Checkbox>
```
...
```tsx
<Checkbox validationState={'error' | 'none'}>is klear360 awesome?</Checkbox>
```
...
<CheckboxGroup
  label="Developers"
  helpText="Pick klear360 developers"
  defaultValue={['maya', 'jordan']}
>
  <Checkbox value="maya">Maya</Checkbox>
  <Checkbox value="jordan">Jordan</Checkbox>
  <Checkbox value="riley">Riley</Checkbox>
</CheckboxGroup>
```
...
```tsx
const Controlled = () => {
  const [selected, setSelected] = React.useState(['maya', 'jordan']);
