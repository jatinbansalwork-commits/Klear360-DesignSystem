...
export default {
  ...
  args: {
    ...
    body:
      'Create Klear Payments Links and share them with your customers from the Klear Dashboard or using APIs and start accepting payments. Check the advantages, payment methods, international currency support and more.',
    footerPrimaryAction: {
      text: 'Learn More',
      onClick: () => {
    ...
    <InfoCardComponent width="280px" {...stateProps}>
      <InfoCardBody>
        <Box display="flex" flexDirection="row" justifyContent="space-between" alignItems="center">
          <Text weight="semibold">Klear Summit 2026</Text>
