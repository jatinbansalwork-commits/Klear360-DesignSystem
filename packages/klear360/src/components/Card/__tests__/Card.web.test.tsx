...
describe('<Card />', () => {
  ...
  it('should only accept allowed components in Card Header', () => {
    ...
    expect(() =>
      ...
      '[Klear360: CardHeaderLeading]: Only `CardHeaderIcon` component is accepted in prefix',
    );
  ...
  it('should throw error if any sub card components are used outside of Card', () => {
    ...
    expect(() => renderWithTheme(<CardBody>body</CardBody>)).toThrow(
      '[Klear360: Card]: CardBody cannot be used outside of Card component',
    );
    expect(() => renderWithTheme(<CardHeader />)).toThrow(
      '[Klear360: Card]: CardHeader cannot be used outside of Card component',
    );
    expect(() => renderWithTheme(<CardHeaderLeading title="" />)).toThrow(
      '[Klear360: Card]: CardHeaderLeading cannot be used outside of Card component',
    );
    expect(() => renderWithTheme(<CardHeaderTrailing />)).toThrow(
      '[Klear360: Card]: CardHeaderTrailing cannot be used outside of Card component',
    );
    expect(() => renderWithTheme(<CardFooter />)).toThrow(
      '[Klear360: Card]: CardFooter cannot be used outside of Card component',
    );
    expect(() => renderWithTheme(<CardFooterLeading title="" />)).toThrow(
      '[Klear360: Card]: CardFooterLeading cannot be used outside of Card component',
    );
    expect(() => renderWithTheme(<CardFooterTrailing />)).toThrow(
      '[Klear360: Card]: CardFooterTrailing cannot be used outside of Card component',
    );
    mockConsoleError.mockRestore();
  });
  ...
  it('should restrict childrens & only allow CardHeader, CardBody & CardFooter in Card', () => {
    ...
    expect(() =>
      ...
      '[Klear360: Card]: Only `CardHeader, CardBody, CardFooter` components are accepted in `Card` children',
    );
    mockConsoleError.mockRestore();
  });
  ...
  it('should restrict childrens in CardHeader', () => {
    ...
    expect(() =>
      ...
      '[Klear360: CardHeader]: Only `CardHeaderLeading, CardHeaderTrailing` components are accepted in `CardHeader` children',
    );
    mockConsoleError.mockRestore();
  });
  ...
  it('should restrict childrens in CardFooter', () => {
    ...
    expect(() =>
      ...
      '[Klear360: CardFooter]: Only `CardFooterLeading, CardFooterTrailing` components are accepted in `CardFooter` children',
    );
    mockConsoleError.mockRestore();
  });
