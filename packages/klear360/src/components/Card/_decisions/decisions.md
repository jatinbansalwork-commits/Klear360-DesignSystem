...
[Figma Link](https://www.figma.com/file/jubmQL9Z8V7881ayUD95ps/Klear360---Payment-Light?node-id=5200%3A0) to all variants of the Card component
...
```jsx
import { Card, CardHeader, CardHeaderIcon } from "@klear/klear360/components";
...
>
> Participants: Maya, Jordan, Sam, Morgan, Riley, Alex, Priya
...
>
> **Agenda:** Discussing few concerns with the previously finalized API, which engineering raised.
>
> Participants: Maya, Jordan, Riley, Morgan, Priya
...
>
> Participants: Maya, Jordan, Riley, Morgan, Alex, Priya
...
>
> Participants: Maya, Jordan, Riley, Morgan, Alex
