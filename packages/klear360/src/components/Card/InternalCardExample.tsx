      ...
      >
        ...
        <CardBody>
          <Text position="relative" zIndex={1}>
            Create Klear Payments Links and share them with your customers from the Klear Dashboard
            or using APIs and start accepting payments. Check the advantages, payment methods,
            international currency support and more.
          </Text>
        </CardBody>
