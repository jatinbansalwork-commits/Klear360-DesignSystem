    ...
    >
      ...
      <Box marginY="spacing.6">
        <Sandbox>
          {`
        import React from 'react';
        import { Card, CardBody, Box, Text, Amount, VisuallyHidden } from '@klear/klear360/components';
...
export const LinkableCard = (): React.ReactElement => {
  return (
    <Box>
      ...
      <Card
        href="https://klear.com/payment-links"
      ...
      >
        ...
        <CardBody>
          ...
          <Link marginTop="spacing.4" href="https://klear.com/payment-links/#overview">
            Get Demo
          </Link>
        </CardBody>
      </Card>
    ...
    <Box display="flex" gap="spacing.6" flexDirection="column">
      <Box>
        ...
        <Text marginBottom="spacing.4">
          Choose your primary Klear product to get started. You can add more products later from
          your dashboard.
        </Text>
...
export const MultiSelectableCardWithCheckbox = (): React.ReactElement => {
  ...
  const errorText = hasError
    ? 'Please select at least one Klear product to get started'
    : hasMaxError
  ...
  return (
    <Box display="flex" gap="spacing.6" flexDirection="column">
      <Box>
        ...
        <Text marginBottom="spacing.4">
          Choose multiple Klear products you want to integrate. You can always add more products
