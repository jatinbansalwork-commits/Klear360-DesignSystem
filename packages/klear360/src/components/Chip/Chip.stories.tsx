    ...
    <StoryPageWrapper
      ...
      note={
        <Text>
          ...
          <Link
            target="_blank"
            href="https://klear360.klear.com/?path=/docs/components-chip-chipgroup"
          >
            here.
          </Link>
          <br />
          Use <Code size="medium">icon</Code> for Klear360 icons and{' '}
          <Code size="medium">leading</Code> for custom leading elements like flags or avatars. They
...
export default {
  ...
  argTypes: {
    ...
    icon: {
      name: 'icon',
      description:
        'Displays a Klear360 Icon component within the Chip. Mutually exclusive with `leading`.',
      type: 'select',
