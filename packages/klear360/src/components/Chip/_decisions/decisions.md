...
[Figma Link](https://www.figma.com/file/jubmQL9Z8V7881ayUD95ps/Klear360---Payment-Light?type=design&node-id=52377%3A27686&mode=design&t=pFzCay0x4a6sTcoQ-1) to all variants of the `Chip` component.
...
| **icon**                | `Icon`                                 | `undefined` | Displays the Klear360 Icon component within the Chip                                                                                                  | ❌       |
