...
const Page = (): React.ReactElement => {
  return (
    <StoryPageWrapper
      ...
      imports={`import { Chip, ChipGroup } from '@klear/klear360/components';\nimport type { ChipProps, ChipGroupProps } from '@klear/klear360/components';`}
      figmaURL="https://www.figma.com/proto/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?type=design&node-id=75272-53870&t=TGcKiXJiozSRKwOG-1&scaling=min-zoom&page-id=52377%3A23885&mode=design"
      note={
        <Text>
          ...
          <Link target="_blank" href="https://klear360.klear.com/?path=/docs/components-chip-chip">
            here
          </Link>
        </Text>
      }
    >
      ...
      <Sandbox showConsole editorHeight={400}>
        {`
          import { Box, Chip, ChipGroup, Text } from '@klear/klear360/components';
...
export default {
  ...
  argTypes: {
    ...
    icon: {
      name: 'icon',
      description:
        'Displays a Klear360 Icon component within each Chip. Mutually exclusive with `leading`.',
      type: 'select',
...
export const chipRef: StoryFn<typeof ChipGroupComponent> = (args) => {
  ...
  const chipRef = React.useRef<Klear360ElementRef>(null);
  // eslint-disable-next-line react-hooks/rules-of-hooks
