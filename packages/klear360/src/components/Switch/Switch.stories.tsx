...
const Page = (): React.ReactElement => {
  return (
    <StoryPageWrapper
      ...
      figmaURL="https://www.figma.com/proto/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?type=design&node-id=74864-85736&t=k8yrOO74u7fLzkIE-1&scaling=min-zoom&page-id=30100%3A565839&mode=design"
    >
      <Title>Usage</Title>
      <Sandbox>
        {`
        import { Switch } from '@klear/klear360/components';
      ...
      <Alert
        ...
        description={
          <>
            ...
            <Link href="https://www.figma.com/file/jubmQL9Z8V7881ayUD95ps/Klear360---Payment-Light?type=design&node-id=31919-629519&t=9TijeCLrhExSrH1z-0">
...
export const SwitchRef: StoryFn<typeof SwitchComponent> = () => {
  const switchRef = React.useRef<Klear360ElementRef>(null);
