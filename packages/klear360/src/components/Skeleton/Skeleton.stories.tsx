...
const Page = (): React.ReactElement => {
  return (
    <StoryPageWrapper
      ...
      figmaURL="https://www.figma.com/proto/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?type=design&node-id=74864-85414&t=R6i97c0Mf28p8ZvY-1&scaling=min-zoom&page-id=16498%3A256331&mode=design"
    >
      <Heading size="large">Usage</Heading>{' '}
      <Sandbox>
        {`
        import { Skeleton } from '@klear/klear360/components';
...
const SkeletonCardTemplate: StoryFn<typeof SkeletonComponent> = () => {
  ...
  return (
    <>
      ...
      <Text marginY="spacing.4">
        You can also use Skeleton to show loading states for existing klear360 components by
      ...
      <Box width={{ xs: '100%', m: '400px' }} marginTop="spacing.4">
        {isLoading ? (
          ...
          <Card>
            ...
            <CardBody>
              <Text>
                Klear Payment Pages is the easiest way to accept payments with a custom-branded
    ...
    <>
      ...
      <List>
        ...
        <ListItem>
          ...
          <ListItemCode>announce()</ListItemCode> method exposed by klear360 to convey the loading
          state to the user.
        </ListItem>
      </List>
