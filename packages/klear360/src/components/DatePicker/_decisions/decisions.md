...
[Figma Link](https://www.figma.com/design/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?node-id=88832-1749327&m=dev) to all variants of the DatePicker component
...
```jsx
import { Calendar, Dropdown, DropdownButton, DropdownOverlay } from '@klear/klear360/components';
import { getFormattedDate } from '@klear/klear360/utils';
...
We need to figure out how to integrate the date picker with the i18n library,
...
- The dayjs locale names and the i18n library locale names are different, so we need to map them.
