...
function LayoutPrimitivesDocs(): React.ReactElement {
  return (
    <StoryPageWrapper
      ...
      componentDescription="Layout Primitives from Klear360. Use this for adding spacings, grids, and any of your layout needs"
      imports=""
    ...
    >
      ...
      <List marginY="spacing.6" marginBottom="spacing.8">
        ...
        <ListItem>
          <ScrollIntoViewLink href="#styled-props">
            Styled Props for Klear360 Components
          </ScrollIntoViewLink>
        </ListItem>
      ...
      <Section id="playground">
        ...
        <Sandbox padding="spacing.0">
          {`
            import { Box, Text } from '@klear/klear360/components'
      ...
      <Section id="box-usage">
        ...
        <Section id="adding-margin-and-padding">
          ...
          <Text>
            Klear360 supports multiple props like <Code>padding</Code>, <Code>paddingX</Code>,{' '}
      ...
      <Section id="styled-props" paddingBottom="spacing.0">
        ...
        <Text>
          Want to add spacing between 2 elements? add layout props directly on the Klear360
          components ✨
        </Text>
        ...
        <Sandbox>
          {`
              import { Alert } from '@klear/klear360/components';
      ...
      <Section id="questions-you-might-have" paddingTop="spacing.0">
        ...
        <BaseBox id="why-is-xyz-prop-not-support" paddingY="spacing.4">
          ...
          <List>
            ...
            <ListItem>
              Is there any alternate Klear360 component that can be used instead?
              <List>
                <ListItem>
          ...
          <Text>
            We are open for suggestions on this. You can create an issue on klear360 repo to discuss
            any of the API decisions. Extra points if you can mention any klear-specific issues you
            are facing with Box or styled-props API.
          </Text>
        </BaseBox>
