import type { StyledPropsKlear360 } from '../BaseBox/types';
 ...
 */
const makeStyledProps = (props: StyledPropsInputType): KeysRequired<StyledPropsKlear360> => {
  return {
 ...
 *
 * ```tsx
 * import type { StyledPropsKlear360 } from '~src/components/Box/styledProps';
 ...
 */
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const getStyledProps = (props: Record<string, any>): StyledPropsKlear360 => {
  return removeUndefinedStyledProps(makeStyledProps(props));
};

export type { StyledPropsKlear360 };
