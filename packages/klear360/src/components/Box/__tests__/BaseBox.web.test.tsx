...
describe('<BaseBox />', () => {
  ...
  it('should have proper meta attributes', () => {
    ...
    expect(getByText('hello')).toHaveAttribute('data-klear360-component', MetaConstants.BaseBox);
  });
  ...
  it('passed in metaAttribute should override default one', () => {
    ...
    expect(getByText('hello')).toHaveAttribute('data-klear360-component', 'test');
  });
