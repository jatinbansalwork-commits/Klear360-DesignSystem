...
const Page = (): React.ReactElement => {
  return (
    <StoryPageWrapper
      ...
      imports={`import { SegmentedControl, SegmentedControlItem } from '@klear/klear360/components';`}
      note={
        <Text>
          SegmentedControl can look visually similar to{' '}
          <Link target="_blank" href="https://klear360.klear.com/?path=/docs/components-tabs--docs">
            Tabs
          </Link>
    ...
    >
      ...
      <Sandbox editorHeight={300}>
        {`
          import { Box, SegmentedControl, SegmentedControlItem } from '@klear/klear360/components';
