        ...
        <BottomSheetBody>
          <List>
            ...
            <ListItem>
              ...
              Malorum" (If you don't use klear360 we will haunt you) by Cicero, written in 45 BC.
...
WithHeaderFooter.args = {
  ...
  subtitle: 'Saving addresses makes future deliveries faster',
  trailing: 'Badge',
  titleSuffix: 'Counter',
      ...
      >
        ...
        <BottomSheetBody>
          ...
          <List marginTop="spacing.5">
            <ListItem>Maya Chen</ListItem>
            <ListItem>Jordan Hale</ListItem>
            <ListItem>Sam Ortiz</ListItem>
          </List>
        </BottomSheetBody>
      </BottomSheetComponent>
    </BaseBox>
    ...
    <Box position="relative" height="250px" overflow="hidden">
      <Box position="absolute" top="-150px" left="spacing.0" width="100%">
        <video
          ...
          width="100%"
          height="100%"
          src="https://cdn.klear.com/static/assets/klear.com/x/escrow-accounts/hero-illustration.mp4"
        />
      </Box>
      <Box position="absolute" bottom="spacing.4" left="spacing.5">
          ...
          <Box display="flex" flexDirection="column">
            ...
            <Box padding="spacing.5" display="flex" flexDirection="column">
              ...
              <Text marginTop="spacing.3" color="surface.text.gray.muted">
                100% secure | Instant transfers | Unbeatable pricing
              </Text>
            </Box>
          </Box>
        </BottomSheetBody>
  ...
  return (
    <BaseBox>
      ...
      <Box marginTop="spacing.3">
        ...
        <Text>
          Checkout the{' '}
          <Link href="https://www.figma.com/proto/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?type=design&node-id=76785-1455819&t=eMQWVawMPyhCdtgv-1&scaling=min-zoom&page-id=25042%3A498654&mode=design">
            design guideline
          </Link>{' '}
