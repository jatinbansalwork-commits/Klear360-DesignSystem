...
- Jordan and i were discussing the Footer, it seems that given the usecases, it might be just better to provide the slot as is.
...
<BaseHeader>
  ...
  <BaseHeaderLeading
    title=""
    subtitle=""
    prefix={AssetComponent | Klear360Icon}
    suffix={<Counter />}
  />
