    ...
    >
      ...
      <Sandbox editorHeight={400}>
        ...
        function App() {
          ...
          // (set on Klear360Provider) — dark app renders the dark banner,
...
DarkColorScheme.parameters = {
  docs: {
    description: {
      story:
        'When the app `colorScheme` is `dark` (set on `Klear360Provider`), the banner automatically renders the dark treatment — a translucent dark background with light text. No prop is required.',
    },
  },
};
