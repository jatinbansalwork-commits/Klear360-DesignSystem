...
describe('<List />', () => {
  ...
  it('should throw error on nesting more than 3 levels', () => {
    ...
    ).toThrow('[Klear360: List]: List Nesting is allowed only upto 3 levels.');
  ...
  it('should throw error on using a non-valid component in ListItem', () => {
    ...
    expect(() =>
      ...
      '[Klear360: ListItem]: You can only pass a List, ListItemLink, ListItemCode, ListItemText or a string as a child to ListItem.',
    );
    mockConsoleError.mockRestore();
  });
  ...
  it('should throw error on using a non-valid component in List', () => {
    ...
    ).toThrow('[Klear360: List]: You can only pass a ListItem as a child to List.');
    mockConsoleError.mockRestore();
  });
