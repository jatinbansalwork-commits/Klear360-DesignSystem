...
## Design
- [Figma - List](https://www.figma.com/file/jubmQL9Z8V7881ayUD95ps/Klear360---Payment-Light?node-id=23205%3A446859&t=dT849yOxgX5WHgby-4)
...
| icon | `Klear360Icon` | `undefined` | Icon to be used for the items in the list. This can only be set when `variant` is `unordered`. |  |
...
### Sample Usage
```jsx
import { List, InfoIcon, EditIcon } from '@klear/components';
