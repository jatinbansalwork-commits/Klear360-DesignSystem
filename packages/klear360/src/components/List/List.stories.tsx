...
const Page = (): ReactElement => {
  return (
    ...
    >
      ...
      <Sandbox>
        {`
          import { List, ListItem } from '@klear/klear360/components';
        ...
        <BaseBox key={size}>
          ...
          <List variant="ordered-filled" size={size}>
            <ListItem>
              ...
              Klear Web Standard Checkout on your website.
            </ListItem>
            <ListItem>
      ...
      {listSizes.map((size) => (
        <BaseBox key={size}>
          ...
          <List variant="ordered" size={size}>
            <ListItem>
              Bump klear360 version to <ListItemCode>v6.0.0</ListItemCode>
            </ListItem>
            <ListItem>
