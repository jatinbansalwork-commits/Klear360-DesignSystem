...
const _KlearNowPayrollFilledIcon: IconComponent = ({ size, color, ...styledProps }) => {
...
const KlearNowPayrollFilledIcon = assignWithoutSideEffects(_KlearNowPayrollFilledIcon, {
  componentId: 'KlearNowPayrollFilledIcon',
});

export default KlearNowPayrollFilledIcon;
