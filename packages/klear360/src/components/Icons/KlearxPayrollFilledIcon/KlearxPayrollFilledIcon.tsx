...
const _KlearxPayrollFilledIcon: IconComponent = ({ size, color, ...styledProps }) => {
...
const KlearxPayrollFilledIcon = assignWithoutSideEffects(_KlearxPayrollFilledIcon, {
  componentId: 'KlearxPayrollFilledIcon',
});

export default KlearxPayrollFilledIcon;
