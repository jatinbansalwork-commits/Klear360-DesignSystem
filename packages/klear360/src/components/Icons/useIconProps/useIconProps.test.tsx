...
describe('useIconProps', () => {
  it('should return a xsmall icon with the correct color', () => {
    ...
    expect(result.current.iconColor).toMatchInlineSnapshot(`"hsla(200, 98%, 17%, 1)"`);
  });
  ...
  it('should return a small icon with the correct color', () => {
    ...
    expect(result.current.iconColor).toMatchInlineSnapshot(`"hsla(2, 100%, 90%, 1)"`);
  });
  ...
  it('should return a large icon with the correct color', () => {
    ...
    expect(result.current.iconColor).toMatchInlineSnapshot(`"hsla(193, 31%, 77%, 1)"`);
  });
  ...
  it('should return a xlarge icon with the correct color', () => {
    ...
    expect(result.current.iconColor).toMatchInlineSnapshot(`"hsla(215, 16%, 47%, 1)"`);
  });
