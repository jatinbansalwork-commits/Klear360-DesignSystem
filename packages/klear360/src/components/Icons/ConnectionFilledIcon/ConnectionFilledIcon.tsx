...
const _ConnectionFilledIcon: IconComponent = ({ size, color, ...styledProps }) => {
...
const ConnectionFilledIcon = assignWithoutSideEffects(_ConnectionFilledIcon, {
  componentId: 'ConnectionFilledIcon',
});
