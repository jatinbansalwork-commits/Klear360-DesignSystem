...
const _KlearXIcon: IconComponent = ({ size, color, ...styledProps }) => {
...
const KlearXIcon = assignWithoutSideEffects(_KlearXIcon, {
  componentId: 'KlearXIcon',
});

export default KlearXIcon;
