...
import KlearTrustIcon from './KlearTrustIcon';
...
const Page = (): ReactElement => {
  return (
    <StoryPageWrapper
      componentDescription="Klear360 provides a bunch of icons out of the box in 6 different sizes. You can choose the size & color that fits best for your use case using the color & size props."
      componentName="Icon"
      apiDecisionLink=""
    ...
    >
      ...
      <Sandbox>
        {`
        import { Button, ArrowRightIcon } from '@klear/klear360/components';
      ...
      <Description>
        ...
        file](https://www.figma.com/proto/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?type=design&node-id=59-177&t=asW4d8ea1ARhVt6g-1&scaling=min-zoom&page-id=57%3A0&mode=design)
      </Description>
      <Description>
      ...
      <Description>_(screenshot removed)_</Description>
      <Description>
        4. Replace the native HTML elements with Klear360's components (eg. `svg` becomes `Svg`).
        You may use a tool such as [SVGR](https://react-svgr.com/playground/?native=true) for the
...
export const BrandedIcons: StoryFn<ComponentType<IconProps>> = ({ color, ...args }) => {
  const brandedIcons = { KlearTrustIcon };
