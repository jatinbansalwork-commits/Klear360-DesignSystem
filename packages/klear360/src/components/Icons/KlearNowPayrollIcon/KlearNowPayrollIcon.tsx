...
const _KlearNowPayrollIcon: IconComponent = ({ size, color, ...styledProps }) => {
...
const KlearNowPayrollIcon = assignWithoutSideEffects(_KlearNowPayrollIcon, {
  componentId: 'KlearNowPayrollIcon',
});

export default KlearNowPayrollIcon;
