...
const _KlearxPayrollIcon: IconComponent = ({ size, color, ...styledProps }) => {
...
const KlearxPayrollIcon = assignWithoutSideEffects(_KlearxPayrollIcon, {
  componentId: 'KlearxPayrollIcon',
});

export default KlearxPayrollIcon;
