...
Currently in Klear360, we are planning to add new variants of icons: filled and outlined. This document discusses the development implementation for this change.
...
```javascript
<Klear360Icon variant="outline"/>
<Klear360Icon variant="filled"/>
```
...
Alex Rivera suggested that if we use variants of the same icon, the bundle size will increase as we add more icons.
