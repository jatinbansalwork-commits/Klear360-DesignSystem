...
export const WithScrollablePage = () => {
  ...
  const steps = React.useMemo<SpotlightPopoverTourSteps>(
    () => [
      {
        name: 'klear-dashboard',
        title: 'Powerful Dashboard',
        content: () => {
          return (
            <Box>
              <Text color="surface.text.gray.subtle">
                Klear provides a Powerful Dashboard for you to get reports and detailed statistics
                on payments, settlements, refunds and much more for you to take better business
                decisions.
              </Text>
            </Box>
          );
      ...
      },
      {
        ...
        content: () => {
          return (
            <Box>
              <Text color="surface.text.gray.subtle">
                With Amazon AWS, we are built for scale. To ensure that products built with Klear
      ...
      },
      {
        ...
        content: () => {
          return (
            <Box>
              <Text color="surface.text.gray.subtle">
                With SDKs and documentation for all major languages and platforms, Klear is built
                for developers.
              </Text>
            </Box>
          );
        ...
        <TourScrollableFrame>
          ...
          <Box>
            ...
            */}
            ...
            >
              <Text>A</Text>
              <SpotlightPopoverTourStep name="klear-dashboard">
                <Link href="https://dashboard.klear.com">Powerful Dashboard</Link>
              </SpotlightPopoverTourStep>
              <Text>
            ...
            >
              <Text>
                ...
                don’t have to. Klear's servers are completely hosted on
              </Text>
            ...
            >
              ...
              <SpotlightPopoverTourStep name="klear-docs">
                <Link href="https://klear.com/docs/api/">developer friendly APIs</Link>
              </SpotlightPopoverTourStep>
              <Text>
