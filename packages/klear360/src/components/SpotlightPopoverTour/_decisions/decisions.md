...
[Figma Link](https://www.figma.com/file/jubmQL9Z8V7881ayUD95ps/Klear360---Payment-Light?node-id=63871%3A13263&mode=dev) to all variants of the SpotlightPopover component
...
type Step = {
   ...
   *
   * Can be any klear360 icon or asset.
   */
...
- We don't expose `id` for every klear360 component, currently only Box does.
...
```jsx
import { SpotlightPopover, SpotlightPopoverFooter } from '@klear/klear360/components';
import type { SpotlightPopoverSteps } from '@klear/klear360/components';
...
Jordan suggested few ways to directly use the `ref` and letting consumer attach the ref to the components, but that had few issues concerning complexity & overhead for consumers.
...
import { SpotlightPopover } from '@klear/klear360/components';
import type { SpotlightPopoverSteps } from '@klear/klear360/components';
...
> This is just for the klear360 team's future reference.
...
For example, just taking an example of this [SpotlightPopover flow in Dashboard](https://github.com/klear/dashboard/blob/44a954660b0d851cd5fedf48b44d85731e5c48ea/web/js/merchantLA/containers/MerchantSpotlightPopover/index.js):

The content of the popover is in separate files:

- [dashboard/web/js/merchant/containers/Home
  /Desktop.js](https://github.com/klear/dashboard/blob/44a954660b0d851cd5fedf48b44d85731e5c48ea/web/js/merchant/containers/Home/Desktop.js#L789)
- [dashboard/web/js/merchant/containers/Home/KeyMetrics
  /Panel.js](https://github.com/klear/dashboard/blob/44a954660b0d851cd5fedf48b44d85731e5c48ea/web/js/merchant/containers/Home/KeyMetrics/Panel.js#L393)
- [dashboard/web/js/merchant/containers/Home/Traffic
  /index.js](https://github.com/klear/dashboard/blob/44a954660b0d851cd5fedf48b44d85731e5c48ea/web/js/merchant/containers/Home/Traffic/index.js#L328)
- [dashboard/web/js/merchant/components/HeaderNav
  /index.js](https://github.com/klear/dashboard/blob/44a954660b0d851cd5fedf48b44d85731e5c48ea/web/js/merchant/components/HeaderNav/index.js#L295)
- **4 more files....... 🤯**
...
**Participants:** Design, Engineering, Product
**Date:** 6th Nov, 2023

**Discussion Points**

1. Letting consumers compose their own tour flows - Giving context to engineering
...
Gave context to engineering on the discussion that design and product already did on the challenges & issues with letting consumers compose Popover to create flows.
...
- Dashboard's [SpotlightPopover](https://github.com/klear/dashboard/blob/44a954660b0d851cd5fedf48b44d85731e5c48ea/web/js/merchantLA/containers/MerchantSpotlightPopover/index.js) component
