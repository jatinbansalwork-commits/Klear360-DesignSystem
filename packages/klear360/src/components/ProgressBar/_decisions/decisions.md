...
## Design
- [Figma - ProgressBar](https://www.figma.com/file/jubmQL9Z8V7881ayUD95ps/Klear360---Payment-Light?node-id=16430%3A256423)
...
### Sample Usage
```jsx
import { ProgressBar } from '@klear/components';
