...
[Figma Link](https://www.figma.com/file/LSG77hEeVYDk7j7WV7OMJE/Klear360-DSL---Components-Guideline?type=design&node-id=2875-40870&mode=design&t=mTbpUCQOr7kHk6UT-0) to all variants of the Popover component
...
```js
import { Popover, PopoverInteractiveWrapper } from '@klear/klear360';
...
```jsx
import type { PopoverTriggerProps } from "@klear/klear360/components";
...
Apart from normal Popovers while we audited the components used in Klear, we also found instances of Guided Popovers (Tour component), which can be used to guide users through a flow.
