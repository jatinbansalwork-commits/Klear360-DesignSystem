...
const klearData: TableData<TransactionItem> = {
  nodes: [
    {
      id: 'txn_001',
      merchant: 'Flipkart',
...
export const RowSpan: StoryFn<typeof TableComponent> = () => {
  const rowSpans = calculateRowSpans(klearData.nodes, 'merchant');
            ...
            <TableBody>
              <TableRow item={tableData[0]}>
                <TableCell gridColumnStart={1} gridColumnEnd={7}>
                  Transaction Summary - Total: {klearData.nodes.length} transactions processed
                </TableCell>
              </TableRow>
              {tableData.map((item, index) => (
...
export const FooterSpan: StoryFn<typeof TableComponent> = () => {
  const grouped = groupBy(klearData.nodes, 'merchant');
  const totalSettlement = klearData.nodes.reduce((sum, item) => sum + item.settlement, 0);
            ...
            <TableFooter>
              <TableFooterRow>
                <TableFooterCell gridColumnStart={1} gridColumnEnd={6}>
                  <Text weight="regular">
                    Total Summary ({Object.keys(grouped).length} merchants, {klearData.nodes.length}{' '}
                    transactions)
                  </Text>
                </TableFooterCell>
                <TableFooterCell>
...
export const ColumnRowSpan: StoryFn<typeof TableComponent> = () => {
  const merchantSpans = calculateRowSpans(klearData.nodes, 'merchant');
          ...
          <>
            ...
            <TableFooter>
              <TableFooterRow>
                ...
                <TableFooterCell>
                  <Amount
                    value={klearData.nodes.reduce((sum, item) => sum + item.settlement, 0)}
                    isAffixSubtle={false}
                  />
                </TableFooterCell>
              </TableFooterRow>
          ...
          <>
            ...
            <TableFooter>
              <TableFooterRow>
                ...
                <TableFooterCell>
                  <Amount
                    value={klearData.nodes.reduce((sum, item) => sum + item.amount, 0)}
                    isAffixSubtle={false}
                  />
                </TableFooterCell>
                <TableFooterCell gridColumnStart={4} gridColumnEnd={6}>
                  <Amount
                    value={klearData.nodes.reduce((sum, item) => sum + item.fee, 0)}
                    isAffixSubtle={false}
                  />
                </TableFooterCell>
                <TableFooterCell>
          ...
          <>
            ...
            <TableFooter>
              <TableFooterRow>
                ...
                <TableFooterCell>
                  <Text weight="regular">Items: {klearData.nodes.length}</Text>
                </TableFooterCell>
                <TableFooterCell>
                  <Amount
                    value={klearData.nodes.reduce((sum, item) => sum + item.amount, 0)}
                ...
                <TableFooterCell>
                  <Amount
                    value={klearData.nodes.reduce((sum, item) => sum + item.gst, 0)}
                    isAffixSubtle={false}
                  />
                </TableFooterCell>
                <TableFooterCell>
