        ...
        <Box paddingY="spacing.4" display="flex" gap="spacing.4">
          {
            currentSelections.map((currentSelection) =>
              // @todo for klear360 team: Remove this check once onChange triggers fix goes to production
...
const WithValidationStateStory = `
  ...
  import type { SelectInputProps } from '@klear/klear360/components';
    ...
    return (
      <Box minHeight="300px" paddingBottom="spacing.5">
        ...
        <Dropdown selectionType="multiple">
          ...
          <DropdownOverlay>
            <ActionList>
              <ActionListItem title="Klear360" value="klear360" />
            ...
            <ActionList>
              <ActionListSection title="Account @saurabh">
                ...
                <ActionListItem
                  title="Dashboard"
                  value="dashboard"
                  href="https://dashboard.klear.com/"
                />
                <ActionListItem
                  title="Settings"
                  value="settings"
