...
- `packages/klear360/src/components/Dropdown/FilterChipGroup.web.tsx` (`handleClearButtonClick`)
- `packages/klear360/src/components/Dropdown/FilterChipSelectInput.web.tsx` (clear triggerer effect)
- `packages/klear360/src/components/Dropdown/types.ts` (`FilterChipGroupProps`)
