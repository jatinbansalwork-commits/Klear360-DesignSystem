...
If you have a "Reset" button in your form, there isn't way to de-select an already selected item (legally). For such usecases as well we need controlled Dropdown
...
In the below example, Maya's profile should have "selected" styling in-order to show the current profile
