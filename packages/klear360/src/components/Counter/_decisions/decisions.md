...
[Figma Link](https://www.figma.com/file/jubmQL9Z8V7881ayUD95ps/Klear360---Payment-Light?node-id=8222%3A70827) to all variants of the Counter component
...
```tsx
import { Counter } from '@klear/components';
