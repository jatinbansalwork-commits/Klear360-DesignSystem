...
const Page = (): ReactElement => {
  return (
    <StoryPageWrapper
      ...
      figmaURL="https://www.figma.com/proto/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?type=design&node-id=74858-52172&t=LY9ssuVTANWMEksF-1&scaling=min-zoom&page-id=8222%3A70410&mode=design"
    >
      <Title>Usage</Title>
      <Sandbox>
        {`
          import { Counter } from '@klear/klear360/components';
