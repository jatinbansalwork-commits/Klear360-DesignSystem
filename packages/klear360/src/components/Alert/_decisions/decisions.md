...
- [Figma - Alerts](https://www.figma.com/file/jubmQL9Z8V7881ayUD95ps/Klear360---Payment-Light?node-id=6824%3A0)
...
```jsx
import { Alert, Link } from '@klear/klear360';
...
<Alert
  ...
  description={
    <>
      ...
      accept payments in INR (₹) using PayPal. <Link href="https://klear.com">Know More</Link>
    </>
  }
  actions={{
    primary: { text: 'Primary Action', onClick: {() => { /* do something */ }} },
    secondary: { text: 'Link', onClick: {() => { /* do something */ }}, href: 'https://klear.com'},
  }}
/>;
```
...
<Alert
  ...
  description={
    <>
      ...
      <Link href="https://klear.com">Know More</Link>
    </>
  }
/>
```
