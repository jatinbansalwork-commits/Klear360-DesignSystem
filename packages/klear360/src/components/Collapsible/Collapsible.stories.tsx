...
const Page = (): ReactElement => {
  return (
    <StoryPageWrapper
      ...
      figmaURL="https://www.figma.com/proto/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?type=design&node-id=74858-52005&t=A9ZHVM0ITdF8gCYw-1&scaling=min-zoom&page-id=37282%3A578130&mode=design"
    >
      <Title>Usage</Title>
      <Sandbox editorHeight={500}>
        {`
        import { Collapsible, CollapsibleButton, CollapsibleBody, Text, Amount, Box } from '@klear/klear360/components';
              ...
              <CollapsibleBody>
                <Box display="flex" flexDirection="column" minWidth="200px">
                  ...
                  <Box
                    ...
                    alignItems="baseline"
                  >
                    <Text marginTop="spacing.2">Klear Platform Fees</Text>
                    <Text>2%</Text>
                  </Box>
                  <Box
                    display="flex"
