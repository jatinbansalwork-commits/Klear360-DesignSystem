...
- [Figma - Collapsible](https://www.figma.com/file/LSG77hEeVYDk7j7WV7OMJE/Klear360-DSL---Components-Guideline?type=design&node-id=79-629874&t=sVxH3DOnx3L3F9rO-0)
...
```jsx
import { Collapsible, CollapsibleButton, CollapsibleLink, CollapsibleBody } from '@klear/klear360';
