...
const _Drawer = ({
  ...
  // `Popover.native` / `Tooltip.native` against this same `Klear360BottomSheetPortal` host)
  ...
  return isMounted || !isLazy ? (
    <Portal hostName="Klear360BottomSheetPortal">
 ...
 *  ---
 *
 * Checkout {@link https://klear360.klear.com/?path=/docs/components-drawer Drawer Documentation}
 *
 *
 */
