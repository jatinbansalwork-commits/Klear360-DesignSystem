...
const Page = (): React.ReactElement => {
  return (
    <StoryPageWrapper
      ...
      figmaURL="https://www.figma.com/proto/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?type=design&node-id=78667-66659&t=YFTWKtgOioAyOKwG-1&scaling=min-zoom&page-id=77229%3A6461&mode=design"
    >
      <Title>Usage</Title>
    ...
    <Box>
      ...
      <Drawer isOpen={isSecondDrawerOpen} onDismiss={() => setIsSecondDrawerOpen(false)}>
        ...
        <DrawerBody>
          ...
          >
            <CardHeader>
              <CardHeaderLeading title="Klear FTX" subtitle="Check out our yearly event" />
            </CardHeader>
            <CardBody>
              <Box padding="spacing.4">
                <Text>Book Your Tickets for Klear FTX</Text>
              </Box>
            </CardBody>
            <CardFooter>
              <CardFooterTrailing
