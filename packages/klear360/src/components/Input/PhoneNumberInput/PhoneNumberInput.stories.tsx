...
import type { CountryCodeType } from '@klear/i18n';
import { isValidPhoneNumber } from '@klear/i18n';
    ...
    docs: {
      page: () => (
        ...
        >
          ...
          <Sandbox>
            {`
              import { PhoneNumberInput } from '@klear/klear360/components';
...
const ValidationTemplate: StoryFn<typeof PhoneNumberInput> = () => {
  ...
  return (
    <Box>
      <Text marginBottom="spacing.5">
        You can choose to validate the phone number manually by using the i18n library's{' '}
