    ...
    docs: {
      page: () => (
        ...
        >
          ...
          <Sandbox>
            {`
              import { TextInput } from '@klear/klear360/components';
            ...
            <Dropdown>
              ...
              <DropdownOverlay>
                <ActionList>
                  ...
                  {/* maybe one day */}
                  <ActionListItem title=".klear" value="klear" />
                </ActionList>
              </DropdownOverlay>
            </Dropdown>
          }
          ...
          <Dropdown>
            ...
            <DropdownOverlay>
              <ActionList>
                ...
                <ActionListItem title="@klear-airtelbank" value="klear" />
              </ActionList>
            </DropdownOverlay>
          </Dropdown>
        }
...
TextInputWithLabelSuffixTrailing.args = {
  ...
  labelSuffix: (
    <Tooltip content="Your Tax ID is used to generate invoices and receipts" placement="right">
    ...
    <Box display="flex" flexDirection="column" gap="spacing.8">
      ...
      <Box>
        ...
        <TextInputComponent
          ...
          placeholder="Enter Tax ID"
          labelSuffix={
            <Tooltip content="Your Tax ID is used to generate invoices" placement="right">
              <TooltipInteractiveWrapper display="flex">
                <InfoIcon size="small" color="surface.icon.gray.muted" />
              </TooltipInteractiveWrapper>
            </Tooltip>
