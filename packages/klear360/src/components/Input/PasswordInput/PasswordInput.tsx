...
import type { DataAnalyticsAttribute, Klear360ElementRef } from '~utils/types';
...
const _PasswordInput: React.ForwardRefRenderFunction<Klear360ElementRef, PasswordInputProps> = (
  {
    label,
    accessibilityLabel,
    labelPosition = 'top',
