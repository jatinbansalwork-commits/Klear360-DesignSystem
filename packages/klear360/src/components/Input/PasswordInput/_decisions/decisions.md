...
- [Figma - PasswordInput](https://www.figma.com/file/jubmQL9Z8V7881ayUD95ps/Klear360---Payment-Light?node-id=10953%3A110176)
...
```jsx
import { PasswordInput } from '@klear/klear360';
