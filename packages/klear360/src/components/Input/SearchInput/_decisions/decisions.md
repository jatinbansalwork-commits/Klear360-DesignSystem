...
- [Explore the design in Figma: SearchInput](https://www.figma.com/file/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?type=design&node-id=85072%3A160345&mode=design&t=Pv93G8LK6OtL4wwk-1)
...
```jsx
import React from 'react';
import { Box, SearchInput } from '@klear/klear360/components';
