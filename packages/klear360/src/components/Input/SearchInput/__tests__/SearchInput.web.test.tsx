...
describe('<SearchInput />', () => {
  ...
  it('should throw error when both value and defaultValue are passed', () => {
    ...
    expect(() =>
      renderWithTheme(<SearchInput label="Enter name" defaultValue="Jordan" value="Jordan Hale" />),
    ).toThrow(
  ...
  it('should clear input with defaultValue on clear button click', async () => {
    ...
    const { getByLabelText, getByRole } = renderWithTheme(
      <SearchInput label={label} defaultValue="Jordan" onClearButtonClick={onClearButtonClick} />,
    );
