...
const CLASSNAME = '__klear360-color-input-row';
...
const StyledColorInput = styled(BaseBox)<StyledColorInputProps>`
  ${({ theme, $size }) => {
    ...
    return `
      ...
      & .${CLASSNAME} .__klear360-base-input-wrapper,
      ...
      & .${CLASSNAME} .__klear360-base-input-wrapper:hover,
      & .${CLASSNAME} .__klear360-base-input-wrapper:focus-within {
        z-index: 1;
      }

      /* First input: left border-radius */
      & .${CLASSNAME}:first-child .__klear360-base-input-wrapper,
      ...
      & .${CLASSNAME}:last-child .__klear360-base-input-wrapper,
      ...
      & .${CLASSNAME}:only-child .__klear360-base-input-wrapper,
