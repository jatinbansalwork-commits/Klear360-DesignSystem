 ...
 * ### Tabs
 *
 * Check out the [Tab Stories & Examples](https://klear360.klear.com/?path=/docs/components-tabs--default)
 *
 * ----
 * ### Basic Usage
 *
 * ```jsx
 * import { Tabs, TabList, TabItem, TabPanel } from '@klear/klear360/components';
 *
