...
const Page = (): React.ReactElement => {
  return (
    <StoryPageWrapper
      ...
      figmaURL="https://www.figma.com/proto/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?type=design&node-id=75154-84398&t=QK3OC85vjD0Yt67V-1&scaling=min-zoom&page-id=60438%3A44047&mode=design"
      note={
        <Text>
          Tabs can look visually similar to{' '}
          <Link
            target="_blank"
            href="https://klear360.klear.com/?path=/docs/components-segmentedcontrol--docs"
          >
            SegmentedControl
          </Link>
  ...
  return (
    <Box height={isReactNative() ? '100%' : undefined}>
      <Text>
        ...
        <Link href="https://dashboard.klear.com/app/subscriptions">dashboard</Link>) by wrapping the{' '}
        <Code size="medium">TabList</Code> with a <Code size="medium">Box</Code> and aligning
