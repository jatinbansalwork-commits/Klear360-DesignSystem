...
const Page = (): React.ReactElement => {
  return (
    <StoryPageWrapper
      ...
      figmaURL="https://www.figma.com/proto/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?type=design&node-id=75154-263106&t=labtGW09OHM0uSau-1&scaling=min-zoom&page-id=50174%3A778489&mode=design"
    >
...
const testimonialData: TestimonialData[] = [
  ...
  },
  {
    ...
    longQuote:
      'We were looking for a closed wallet solution for one-step checkout once the money is loaded in the wallet. Klear, our online payment partner, built a white label closed wallet solution which enabled us to create & offer cashbacks and easily refund payments. This improved customer loyalty and the trust in our brand.',
    name: 'Ashish Somani',
  ...
  },
  {
    ...
    longQuote:
      'Klear has been an important partner for our business. We are currently using Smart collect and Route marketplace for collecting payments from users. Their innovative products and quick support has helped us scale our offering to our users. From onboarding documentation to technical integration, Klear has been a boon for Indian tech startups.',
  ...
  },
  {
    ...
    longQuote:
      '50% of our payments come via NEFT, RTGS and, IMPS bank transfers. Reconciliation of payments was a tedious and cumbersome process. Klear Smart Collect has helped us automate this end-to-end and simplified the process for Finance and Operations team.',
    name: 'Shailesh Gupta',
    role: 'Founder',
    company: 'innov8',
  },
  ...
  },
  {
    ...
    longQuote:
      'By using the card tokenization feature on Klear Subscriptions, we were able to eliminate up-front deposits for a majority of our customers. This helped us reduce outstandings by 18% and improved our retention numbers, as more customers were able to afford the product.',
