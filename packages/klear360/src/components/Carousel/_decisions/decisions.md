...
[Figma Link](https://www.figma.com/file/LSG77hEeVYDk7j7WV7OMJE/Klear360-DSL---Components-Guideline?type=design&node-id=2115-975416&mode=design&t=gjEux4FLvrLihxbH-0) to all variants of the Carousel component
...
| shouldAddStartEndMargin  | `boolean`                              | `false`                                  | If true, adds extra margin before and after the first/last slides so that they align in center, this prop can be used to achive carousel which is in [GST page](https://klear.com/gst-number-search/pan/) |          |
