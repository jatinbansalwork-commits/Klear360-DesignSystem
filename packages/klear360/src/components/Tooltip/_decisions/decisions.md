...
[Figma Link](https://www.figma.com/file/jubmQL9Z8V7881ayUD95ps/Klear360---Payment-Light?type=design&node-id=40540-559304&t=tmTrf3xJU6oj59fM-0) to all variants of the Tooltip component
...
```js
import { Tooltip, TooltipInteractiveWrapper } from '@klear/klear360';
...
```jsx
import type { TooltipTriggerProps } from "@klear/klear360/components";
...
To make FloatingUI work with Klear360 components seamlessly there are few things we need to modify:
