...
const Page = (): React.ReactElement => {
  return (
    <StoryPageWrapper
      ...
      figmaURL="https://www.figma.com/proto/jubmQL9Z8V7881ayUD95ps/Klear360-DSL?type=design&node-id=74864-86058&t=yvLu210sawTgjmt0-1&scaling=min-zoom&page-id=37400%3A560753&mode=design"
    >
      <Title>Usage</Title>
      <Sandbox>
        {`
        import { Tooltip, Button } from '@klear/klear360/components'
...
const PlacementBox = React.forwardRef<
  HTMLDivElement,
  { children: React.ReactNode } & Klear360CommonEvents
>(({ children, ...props }, ref) => {
  return (
    <Box
      ref={ref}
...
const NonInteractiveTriggerTemplate: StoryFn<typeof TooltipComponent> = (args) => {
  return (
    <Box>
      ...
      <Text>
        You can wrap the element in TooltipInteractiveWrapper component provided by klear360
      </Text>
  ...
  return (
    <List>
      ...
      <ListItem>
        ...
        <ListItemText as="span" color="surface.text.gray.muted">
          (you can import the TooltipTriggerProps type from klear360 when using TypeScript)
        </ListItemText>
        <List>
...
const CustomTriggerTemplate = () => {
  return (
    <Box>
      ...
      <Text marginBottom="spacing.4">
        If you are using TypeScript you can import the types for these events from klear360 as{' '}
        <Code size="medium">Klear360CommonEvents</Code>
      </Text>
