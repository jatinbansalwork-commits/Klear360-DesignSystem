...
import { Link as Klear360Link } from '../Link';
...
import { KlearLogo } from './assets/klear';
                ...
                {links.map((link, index) => (
                  <Box width="100%" key={index}>
                    <ReactRouterDomLink key={index} to={link.link}>
                      <Klear360Link key={index} color="primary" size="medium">
                        {link.label}
                      </Klear360Link>
                    </ReactRouterDomLink>
                  </Box>
        ...
        >
          ...
          >
            <ReactRouterDomLink to="/settings">
              <Klear360Link icon={ChevronLeftIcon} size="small">
                Back
              </Klear360Link>
            </ReactRouterDomLink>
          </Box>
        ...
        >
          ...
          >
            <Box display="flex" flexDirection="column" gap="spacing.5">
              {/* Name field */}
              <CardRow label="Name" value="Klear360 Team" />
          ...
          <SubSectionCard
            title="Notifications"
            subtitle="Receive notifications from Klear on your phone/email for any account related updates"
          >
            <Box display="flex" flexDirection="column" gap="spacing.5">
              <CardRow
                label="Email"
