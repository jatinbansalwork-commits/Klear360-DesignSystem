...
- [Figma - Amount](https://www.figma.com/file/jubmQL9Z8V7881ayUD95ps/Klear360---Payment-Light?node-id=28012%3A580578&t=3peAz8A2n2Gw4WMl-1)
...
```jsx
import { Amount } from '@klear/components';
