...
const BASE_URL = 'https://klear360-chat.dev.klear.in';
...
const klear360Knowledge = fs.readFileSync(path.resolve(__dirname, './knowledge/Table.md'), 'utf-8');
...
I want you to migrate our old codebase code from custom implementation, to use our design-system component called Klear360.

You will find code snippets of these things below-

1. Klear360's Table Documentation: Documentation of our design-system table
...
Return Format:
- Refer to Klear360's Table documentation and Custom Component Definitons and Migration Example and return the migrated code snippet of usage using Klear360
...
- Make sure Klear360's Header and Footer are also used wherever needed.
- Ignore the code related to mobile responsiveness as Klear360 components are responsive by default

## 1. Klear360's Table Documentation
${klear360Knowledge}
