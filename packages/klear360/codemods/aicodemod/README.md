...
## 1. Install Klear360 Globally

```sh
npm install -g @klear/klear360
```
...
> **POC Limitations**
>
> As currently its just POC, its optimized to only migrate to Klear360 Table component. It can also
