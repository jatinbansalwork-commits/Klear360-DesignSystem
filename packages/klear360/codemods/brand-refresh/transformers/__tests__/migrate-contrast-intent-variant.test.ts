  ...
  const result = await applyTransform(
    ...
    const App = () => (
      <>
        ...
        <Link color="default" href="https://github.com/jatinbansalwork-commits/Klear360" variant="anchor">
          Learn More
        </Link>

        <CardHeaderLink color="default" href="https://github.com/jatinbansalwork-commits/Klear360" variant="anchor">
          Learn More
        </CardHeaderLink>
  ...
  expect(result).toMatchInlineSnapshot(`
    "const App = () => (
          <>
            ...
            <Link color="primary" href="https://github.com/jatinbansalwork-commits/Klear360" variant="anchor">
              Learn More
            </Link>

            <CardHeaderLink color="primary" href="https://github.com/jatinbansalwork-commits/Klear360" variant="anchor">
              Learn More
            </CardHeaderLink>
