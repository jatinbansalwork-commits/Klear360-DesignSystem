...
import { Avatar, Box, Text } from '@klear/klear360/components';
...
```tsx
import React from 'react';
import { Avatar, AvatarGroup, Box } from '@klear/klear360/components';
...
```tsx
import React, { useState } from 'react';
import { Avatar, AvatarGroup, Box, Text } from '@klear/klear360/components';
