...
```ts
// Klear360File — extends the native File interface with upload state fields
...
// Klear360FileList — array of Klear360File objects
...
type ChatInputProps = {
  ...
  onFileReupload?: ({ file }: { file: Klear360File }) => void;
...
import type { Klear360FileList, Klear360File } from '@klear/klear360/components';
...
import { useState, useRef } from 'react';
import { ChatInput } from '@klear/klear360/components';
import type { Klear360FileList } from '@klear/klear360/components';
...
function FullFeaturedChatInput() {
  ...
  const handleSubmit = ({ value, fileList }: { value: string; fileList: Klear360FileList }): void => {
