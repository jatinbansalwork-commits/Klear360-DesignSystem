...
```tsx
import { TextInput, Box } from '@klear/klear360/components';
...
```tsx
import { TextInput, Box, SearchIcon, UserIcon } from '@klear/klear360/components';
...
import { TextInput, Box, MailIcon } from '@klear/klear360/components';
...
function AdvancedTextInputExample() {
  ...
  const getCardIcon = (cardType) => {
    const icons = {
      visa: 'https://cdn.klear.com/card-networks/visa.svg',
      mastercard: 'https://cdn.klear.com/card-networks/mastercard.svg',
      amex: 'https://cdn.klear.com/card-networks/amex.svg',
