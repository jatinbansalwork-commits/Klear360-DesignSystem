...
```tsx
import { Preview, PreviewHeader, PreviewBody, PreviewFooter } from '@klear/klear360/components';
...
import { ArrowLeftIcon, ArrowRightIcon } from '@klear/klear360/components';
...
```tsx
import { Preview, PreviewHeader, PreviewBody } from '@klear/klear360/components';
