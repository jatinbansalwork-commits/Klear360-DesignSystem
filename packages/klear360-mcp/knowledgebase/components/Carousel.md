  ...
  const testimonials = [
    {
      ...
      quote: 'We saw a 35% increase in conversion after integrating Klear Checkout.',
      author: 'Priya Sharma',
      company: 'TechStart',
    },
    {
...
```tsx
import React from 'react';
import { Carousel, CarouselItem, Box, Text, Card, CardBody } from '@klear/klear360/components';
