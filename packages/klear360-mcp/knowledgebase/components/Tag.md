...
import { Tag, FileTextIcon } from '@klear/klear360/components';
...
```tsx
import React from 'react';
import { Tag, Box, FileTextIcon } from '@klear/klear360/components';
...
```tsx
import React from 'react';
import { Tag, Box, TextInput, Button, PlusIcon } from '@klear/klear360/components';
