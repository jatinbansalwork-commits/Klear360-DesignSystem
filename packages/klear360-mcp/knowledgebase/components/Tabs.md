...
```tsx
import { Box, Text, Tabs, TabList, TabItem, TabPanel } from '@klear/klear360/components';
...
```tsx
import { Box, Text, Tabs, TabList, TabItem, TabPanel, Button } from '@klear/klear360/components';
