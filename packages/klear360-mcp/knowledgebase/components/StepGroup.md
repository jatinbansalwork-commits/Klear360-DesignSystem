...
```tsx
import { StepGroup, StepItem, StepItemIndicator, Button, Box } from '@klear/klear360/components';
  ...
  const stepItems = [
    {
      title: 'Introduction',
      timestamp: 'Mon, 15th Oct’23 | 12:00pm',
      description: 'Introduction to Klear Payment Gateway',
    },
    {
      title: 'Personal Details',
...
```tsx
import { StepGroup, StepItem, StepItemIndicator, Box } from '@klear/klear360/components';
