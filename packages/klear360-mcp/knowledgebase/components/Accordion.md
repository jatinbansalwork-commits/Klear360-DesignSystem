...
type AccordionItemProps = {
  ...
  /**
   * Renders a Klear360 icon as title prefix (requires `showNumberPrefix={false}`)
   *
...
import { RoutesIcon, QRCodeIcon, SubscriptionsIcon } from '@klear/klear360/components';
  ...
  return (
    <Accordion>
      ...
      <AccordionItem>
        ...
        />
        <AccordionItemBody>
          Just use Klear. You may also check our docs for detailed instructions.
        </AccordionItemBody>
      </AccordionItem>
...
import { AnnouncementIcon, RoutesIcon } from '@klear/klear360/components';
      ...
      <AccordionItem>
        ...
        <AccordionItemBody>
          <Text color="surface.text.gray.subtle" marginBottom="spacing.4">
            You can use Klear services as described in the documentation.
          </Text>
