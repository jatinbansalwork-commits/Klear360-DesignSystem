...
1. **Create a Table** — Build your data table using the Klear360 `Table` component.
...
│  • QR code                │  │                                            ││
│  +13 more                 │  │ ┌─ Table Slot ───────────────────────────┐ ││
│  ─ BANKING PRODUCTS ─     │  │ │  Replace with Klear360 Table component    │ ││
│  • Line of Credit         │  │ └────────────────────────────────────────┘ ││
│  ─────────────────        │  │                                            ││
...
| Element | Details |
|---|---|
| **Klear360 Component** | `TopNavigation` |
| **Logo** | Klear wordmark (left-aligned) |
...
| Element | Details |
|---|---|
| **Klear360 Component** | `SideNavigation` |
| **Width** | 240px |
...
| Element | Details |
|---|---|
| **Page Title** | `Heading/XLargeSemibold` · Inter SemiBold · 32px · `surface.text.gray.normal` |
...
The table body is a **slot** — replace it with your Klear360 `Table` instance.

| Column type | Recommended Klear360 usage |
|---|---|
...
- **Table:** Same Klear360 Table structure as Desktop; columns scroll horizontally on 375px viewport
- **Header height on mobile:** 48px (vs. 36px on desktop)

## Klear360 Components Used

| Component | Import Path | Usage |
|---|---|---|
| `Button` | `@klear/klear360/components` | Action buttons, pagination, search trigger |
| `Link` | `@klear/klear360/components` | Table cell links, header links |
| `Badge` | `@klear/klear360/components` | Table Status column |
| `Table` | `@klear/klear360/components` | Data grid (slotted in) |
| `Tabs` | `@klear/klear360/components` | Page-level tab navigation |
| `SearchInput` | `@klear/klear360/components` | Filter search field |
| `SelectInput` | `@klear/klear360/components` | Rows-per-page selector in footer |
| `SideNavigation` | `@klear/klear360/components` | Left nav panel (Desktop) |
| `TopNavigation` | `@klear/klear360/components` | App top bar (Desktop) |
| `Switch` | `@klear/klear360/components` | Test Mode toggle |
| `Counter` | `@klear/klear360/components` | Filter count badges |
| `Divider` | `@klear/klear360/components` | Vertical separator between Search & Filter |
| `Avatar` | `@klear/klear360/components` | User initials in top nav |
| `Card` | `@klear/klear360/components` | Quick Filter items (Mobile) |
| `Amount` | `@klear/klear360/components` | Monetary display with currency symbol |
| `Pagination` | `@klear/klear360/components` | Footer prev/next navigation |
...
│       ├── Table [SLOT — replace with Klear360 Table]
│       └── Table Footer
...
import type { TableData, DatesRangeValue } from '@klear/klear360/components';
import { useBreakpoint, useTheme } from '@klear/klear360/utils';
...
import type { TableData, DatesRangeValue, Identifier } from '@klear/klear360/components';
import { useBreakpoint, useTheme } from '@klear/klear360/utils';
