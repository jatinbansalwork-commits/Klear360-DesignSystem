...
```tsx
import React, { useState } from 'react';
import { Box, TextInput, PasswordInput, Button, Alert, Heading , ArrowRightIcon} from '@klear/klear360/components';
    ...
    <form onSubmit={handleSubmit}>
      <Box padding="spacing.4" display="flex" flexDirection="column" gap="spacing.4">
        <Box>
          ...
          <Heading size="medium" weight="regular">
            This is an example form built with Klear360
          </Heading>
        </Box>
