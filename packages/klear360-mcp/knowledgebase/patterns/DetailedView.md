...
- Showing financial summaries (amount, status, metadata) for a order, transfer, or settlement
...
- **Badge 1** (notice/orange): Order or transfer status (e.g. Pending, Processing, Captured)
...
| Component | Use Case |
|---|---|
| `.drawer / single-transfer-view` | Single transfer details (recipient, account, amount, reference) |
| `.drawer / bulk-transfer-view` | Bulk transfer batch details |
