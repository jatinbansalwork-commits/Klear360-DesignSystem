...
Follow these three steps to correctly design any page in the Klear dashboard.
...
import { InfoIcon, LayoutIcon, LogInIcon } from '@klear/klear360/components';
              ...
              <TabNav
                items={[
                  ...
                  },
                  {
                    ...
                    description: 'Organize work across teams.',
                  },
                  {
                    href: '/rize',
                    title: 'Rize',
                      ...
                      {overflowingItems.length > 0 ? (
                        <Menu openInteraction="hover">
                          ...
                          <MenuOverlay>
                            ...
                            <MenuFooter>
                              <Klear360Link href="" icon={ChevronRightIcon} iconPosition="right">
                                View all products
                              </Klear360Link>
                            </MenuFooter>
                          </MenuOverlay>
...
/**
 * React Router v6 Wrapper around Klear360's SideNavLink that passes active state of item based on react router state
 */
const NavLink = (props: {
  icon?: React.ComponentType;
  title: string;
...
const KlearLogo = () => {
  return (
    <img width="116" height="24" src="https://klear.com/newsroom-content/uploads/2020/12/output-onlinepngtools-1-1.png" />
  );
};
