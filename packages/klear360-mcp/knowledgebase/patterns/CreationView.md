        ...
        <Preview>
          ...
          <PreviewBody>
            {isQrGenerated ? (
              <Box>
                <img
                  src="https://blog.klear.in/blog-content/uploads/2021/11/QR-codes-blog-header.png"
                  alt="QR Code"
                  height="400px"
                />
              </Box>
      ...
      >
        <Box display="flex" flexDirection="column" gap="spacing.2">
          ...
          <Text size="medium" weight="regular" color="surface.text.gray.muted">
            ...
            will be visible to you and your team on the Klear dashboard.
          </Text>
        </Box>
          ...
          >
            <Box paddingX="spacing.6">
              <Heading size="medium" weight="semibold">
                Create policy pages with Klear
              </Heading>
              <Text size="medium" weight="regular" color="surface.text.gray.muted">
              ...
              >
                ...
                <TextInput label="Support Email ID" placeholder="support@klear.com" />
              </Box>
            </Box>
            {!isMobile && (
              <Box>
