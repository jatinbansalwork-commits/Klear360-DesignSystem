...
const KLEAR360_SKILL_FILE_PATH = join(SKILL_TEMPLATE_DIRECTORY, 'SKILL.md');
...
const CHECK_SKILL_VERSION_DESCRIPTION = `Get the version from the klear360 skill file. If the file does not exist, send 0.
...
const KLEAR360_CURSOR_RULES_FILE_PATH = join(
  CURSOR_RULES_TEMPLATE_DIRECTORY,
  'frontend-klear360-rules.mdc',
);

const CURSOR_RULES_FILE_NAME = `frontend-klear360-rules.mdc`;

const CONSUMER_CURSOR_RULES_RELATIVE_PATH = `.cursor/rules/${CURSOR_RULES_FILE_NAME}`;

// Klear360 Template
const BASE_KLEAR360_TEMPLATE_DIRECTORY = join(PROJECT_ROOT_DIRECTORY, 'base-klear360-template');
...
export {
  ...
  CURSOR_RULES_TEMPLATE_DIRECTORY,
  KLEAR360_CURSOR_RULES_FILE_PATH,
  CONSUMER_CURSOR_RULES_RELATIVE_PATH,
  CURSOR_RULES_FILE_NAME,
  // Other
  BASE_KLEAR360_TEMPLATE_DIRECTORY,
