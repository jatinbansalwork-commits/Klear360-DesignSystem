...
import { getKlear360DocsResponseText } from '../getKlear360DocsResponseText.js';
...
describe('getKlear360DocsResponseText', () => {
  ...
  it('should return formatted documentation for a single component', () => {
    ...
    const result = getKlear360DocsResponseText({
      docsList: 'Button',
      documentationType: 'components',
    });

    expect(result).toContain('Klear360 components documentation for: Button');
  ...
  it('should return formatted documentation for multiple components', () => {
    ...
    expect(result).toContain('Klear360 components documentation for: Button, Accordion');
    expect(result).toContain('# Button');
  ...
  it('should return error message when file does not exist', () => {
    ...
    expect(result).toContain('Klear360 components documentation for: NonExistent');
  ...
  it('should work with patterns documentation type', () => {
    ...
    expect(result).toContain('Klear360 patterns documentation for: ListView');
  ...
  it('should work with general documentation type', () => {
    ...
    expect(result).toContain('Klear360 general documentation for: Usage');
  ...
  it('should handle multiple patterns', () => {
    ...
    expect(result).toContain('Klear360 patterns documentation for: ListView, DetailedView');
    expect(result).toContain('# ListView');
  ...
  it('should preserve original docsList format in header', () => {
    ...
    expect(result).toContain('Klear360 components documentation for: Button, Accordion, Input');
  });
});
