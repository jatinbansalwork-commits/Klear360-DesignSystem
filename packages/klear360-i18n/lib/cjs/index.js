...
const getLocale = (options = {}) => {
   ...
   * */
  let locale =
    (options === null || options === void 0 ? void 0 : options.locale) || state.getState().locale;
...
const getIntlInstanceWithOptions = (options = {}) => {
  ...
  const intlOptions = (options === null || options === void 0 ? void 0 : options.intlOptions)
    ? Object.assign({}, options.intlOptions)
    : {};
  if (
    (options === null || options === void 0 ? void 0 : options.currency) ||
 ...
 * (locale-data). This allows for customization of how different currencies or other locale-specific
...
const formatNumber = (amount, options = {}) => {
  ...
  try {
    ...
    const intlOptions = (options === null || options === void 0 ? void 0 : options.intlOptions)
      ...
      : {};
    const currencyCode =
      (options === null || options === void 0 ? void 0 : options.currency) || intlOptions.currency;
...
const getCurrencySymbol = (currencyCode) => {
  ...
  if (currencyCode in currencyInformation)
    ...
    throw new Error(
      `The provided currency code is invalid. The received value was: ${String(
        currencyCode,
      )}. Please ensure you pass a valid currency code.`,
    );
};
...
const formatNumberByParts = (amount, options = {}) => {
  ...
  try {
    ...
    return Object.assign(Object.assign({}, formattedObj), {
      isPrefixSymbol:
...
const convertToMajorUnit = (amount, options) => {
  ...
  if (!options.currency || !currencyInfo) {
    throw new Error(
      `The provided currency code is either empty or not supported. The received value was ${
        options.currency === '' ? 'an empty string' : `: ${String(options.currency)}`
      }. Please ensure you pass a valid currency code.`,
    );
  }
...
const detectCountryAndDialCodeFromPhone = (phoneNumber) => {
  ...
  if (phoneNumber.toString().charAt(0) === '+') {
    const cleanedPhoneNumberWithoutPlusPrefix = phoneNumber.toString().replace(/\D/g, '');
    ...
    const matchedCountryCode = matchingCountries.find((country) => {
      ...
      if (regex && matchesEntirely(phoneNumberWithoutDialCode, regex)) return country;
      return undefined;
    });
...
const alternateMasking = (phoneNumberWithoutDialCode) => {
  return String(phoneNumberWithoutDialCode)
    ...
    .reduce(
      (acc, char) => {
        if (/\d/.test(char)) {
          acc.numericCount % 2 !== 0 ? acc.result.push('x') : acc.result.push(char);
          acc.numericCount++;
        }
        return acc;
      },
...
const isValidPhoneNumber = (phoneNumber, countryCode) => {
  ...
  countryCode = countryCode && countryCode in regexMapper ? countryCode : phoneInfo.countryCode;
...
const getDialCodeByCountryCode = (countryCode) => {
   ...
   * */
  if (countryCode in dialCodeForAllCountries) return dialCodeForAllCountries[countryCode];
  else
    throw new Error(
...
const getMaskedPhoneNumber = ({
  ...
  const {
    maskingStyle = exports.MaskingStyle.Full,
    maskedDigitsCount = 0,
    maskingChar = 'x',
  } = maskingOptions;
  ...
  if (phoneNumber) {
    ...
    const formattingTemplate =
      PHONE_FORMATTER_MAPPER[updatedCountryCode] || phoneNumber.replace(/\d/g, 'x');
    switch (maskingStyle) {
 ...
 * OF ANY KIND, either express or implied. See the License for the specific language
 * governing permissions and limitations under the License.
 */ // Portions of the code in this file are based on code from the TC39 Temporal proposal. // Portions of the code in this file are based on code from ICU.
...
function $11d87f3f76e88657$export$b21e0b124e224484(date, time) {
  let hour = 0,
    ...
    millisecond = 0;
  if ('timeZone' in date)
    ({ hour: hour, minute: minute, second: second, millisecond: millisecond } = date);
...
function $735220c2d4774dd3$export$96b1d28349274637(dateTime, duration) {
  ...
  if (
    ...
    let res = $735220c2d4774dd3$export$e16d8520af44a096(
      $11d87f3f76e88657$export$b21e0b124e224484(dateTime),
      {
...
function $735220c2d4774dd3$export$9a297d111fc86b79(dateTime, field, amount, options) {
  ...
  switch (field) {
    case 'hour': {
      ...
      let minDate = $11d87f3f76e88657$export$b4a036af3fc0b032(
      ...
      let minAbsolute = [
        ...
        (ms) =>
          $11d87f3f76e88657$export$1b96692a1ba042ac(ms, dateTime.timeZone).day === minDate.day,
      )[0];
      let maxDate = $11d87f3f76e88657$export$b4a036af3fc0b032(
        $735220c2d4774dd3$export$e5d5e1c1822b6e56(plainDateTime, {
          hour: max,
        }),
        new $3b62074eb05584b2$export$80ee6245ec4f29ec(),
      ...
      let maxAbsolute = [
        ...
        .filter(
          (ms) =>
            $11d87f3f76e88657$export$1b96692a1ba042ac(ms, dateTime.timeZone).day === maxDate.day,
        )
        .pop();
      ...
      return $11d87f3f76e88657$export$b4a036af3fc0b032(
        $11d87f3f76e88657$export$1b96692a1ba042ac(ms, dateTime.timeZone),
        dateTime.calendar,
      );
    }
    case 'minute':
...
function $fae977aafc393c5c$export$f59dee82248f5ad4(time) {
  return `${String(time.hour).padStart(2, '0')}:${String(time.minute).padStart(2, '0')}:${String(
    time.second,
  ).padStart(2, '0')}${time.millisecond ? String(time.millisecond / 1000).slice(1) : ''}`;
}
function $fae977aafc393c5c$export$60dfd74aa96791bd(date) {
  let gregorianDate = $11d87f3f76e88657$export$b4a036af3fc0b032(
    date,
    new $3b62074eb05584b2$export$80ee6245ec4f29ec(),
  );
  return `${String(gregorianDate.year).padStart(4, '0')}-${String(gregorianDate.month).padStart(
    2,
    '0',
...
function $fae977aafc393c5c$export$4223de14708adc63(date) {
  ...
  return `${$fae977aafc393c5c$export$60dfd74aa96791bd(
    date,
  )}T${$fae977aafc393c5c$export$f59dee82248f5ad4(date)}`;
}
...
function $fae977aafc393c5c$export$bf79f1ebf4b18792(date) {
  return `${$fae977aafc393c5c$export$4223de14708adc63(date)}${$fae977aafc393c5c$var$offsetToString(
    date.offset,
  )}[${date.timeZone}]`;
}
...
function $35ea8db9cb2ccb90$var$shiftArgs(args) {
  let calendar =
    typeof args[0] === 'object' ? args.shift() : new $3b62074eb05584b2$export$80ee6245ec4f29ec();
  let era;
...
class $35ea8db9cb2ccb90$export$ca871e8dbb80966f {
  ...
  /** Returns a new `CalendarDateTime` with the given fields set to the provided values. Other fields will be constrained accordingly. */ set(
    ...
    return $735220c2d4774dd3$export$adaa4cf7ef1b65be(
      $735220c2d4774dd3$export$e5d5e1c1822b6e56(this, fields),
      fields,
    );
  }
  /**
  ...
  /** Compares this date with another. A negative result indicates that this date is before the given one, and a positive date indicates that it is after. */ compare(
    ...
    if (res === 0)
      return $14e0f24ef4ac5c92$export$c19a80a9721b80f6(
        this,
        $11d87f3f76e88657$export$b21e0b124e224484(b),
      );
    return res;
  }
  constructor(...args) {
...
class $35ea8db9cb2ccb90$export$d3b7288e7994edea {
  ...
  /** Compares this date with another. A negative result indicates that this date is before the given one, and a positive date indicates that it is after. */ compare(
    ...
    return (
      this.toDate().getTime() -
      $11d87f3f76e88657$export$84c95a83c799e074(b, this.timeZone).toDate().getTime()
    );
  }
  constructor(...args) {
...
function $fb18d541ea1ad717$var$getCachedDateFormatter(locale, options = {}) {
  ...
  if (typeof options.hour12 === 'boolean' && $fb18d541ea1ad717$var$hasBuggyHour12Behavior()) {
    ...
    let pref =
      $fb18d541ea1ad717$var$hour12Preferences[String(options.hour12)][locale.split('-')[0]];
...
const formatDateTime = (date, options = {}) => {
  ...
  switch (options.dateTimeMode) {
    case 'dateOnly':
      finalIntlOptions = {
        year:
          ((_a = options.intlOptions) === null || _a === void 0 ? void 0 : _a.year) || 'numeric',
        month:
          ((_b = options.intlOptions) === null || _b === void 0 ? void 0 : _b.month) || 'numeric',
    ...
    case 'timeOnly':
      finalIntlOptions = {
        hour:
          ((_d = options.intlOptions) === null || _d === void 0 ? void 0 : _d.hour) || 'numeric',
        minute:
          ((_e = options.intlOptions) === null || _e === void 0 ? void 0 : _e.minute) || 'numeric',
        second:
          ((_f = options.intlOptions) === null || _f === void 0 ? void 0 : _f.second) || 'numeric',
      };
      if (((_g = options.intlOptions) === null || _g === void 0 ? void 0 : _g.hour12) !== undefined)
        finalIntlOptions.hour12 =
          (_h = options.intlOptions) === null || _h === void 0 ? void 0 : _h.hour12;
      break;
    case 'dateTime':
      finalIntlOptions = {
        year:
          ((_j = options.intlOptions) === null || _j === void 0 ? void 0 : _j.year) || 'numeric',
        month:
          ((_k = options.intlOptions) === null || _k === void 0 ? void 0 : _k.month) || 'numeric',
        day: ((_l = options.intlOptions) === null || _l === void 0 ? void 0 : _l.day) || 'numeric',
        hour:
          ((_m = options.intlOptions) === null || _m === void 0 ? void 0 : _m.hour) || 'numeric',
        minute:
          ((_o = options.intlOptions) === null || _o === void 0 ? void 0 : _o.minute) || 'numeric',
        second:
          ((_p = options.intlOptions) === null || _p === void 0 ? void 0 : _p.second) || 'numeric',
      };
      if (((_q = options.intlOptions) === null || _q === void 0 ? void 0 : _q.hour12) !== undefined)
        finalIntlOptions.hour12 =
          (_r = options.intlOptions) === null || _r === void 0 ? void 0 : _r.hour12;
      break;
    default:
...
const parseDateTime = (date, options = {}) => {
  ...
  try {
    ...
    const dateTimeFormat = new $fb18d541ea1ad717$export$ad991b66133851cf(
      locale,
      options.intlOptions,
    );
...
const FLAG_4X3_BASE_PATH = '/assets/flags';
const FLAG_BASE_PATH = '/assets/flags';
const LOCALE_DATA_SOURCE = '';
const LOCALE_DATA_SUPPORTED_COUNTRIES = ['IN', 'MY', 'SG', 'US'];
 ...
 *
 * This function makes a network request to central locale-data source and
 * returns a promise for list of all countries with their meta data
 *
 * @returns {Promise} Promise object for all countries
 */
const getAllCountries = () => {
  return fetch(`${LOCALE_DATA_SOURCE}/country/metadata/data.json`)
    .then((res) => res.json())
...
const getStates = (_countryCode) => {
  const countryCode = _countryCode.toUpperCase();
  if (!LOCALE_DATA_SUPPORTED_COUNTRIES.includes(countryCode)) {
  ...
  return fetch(`${LOCALE_DATA_SOURCE}/country/subdivisions/${countryCode}.json`)
    .then((res) => res.json())
    .then((res) => res.states)
    .catch((err) => {
      throw new Error(
...
/**
 * Queries the response received from locale-data and returns a list of zipcodes within the state provided
 * @param response locale-data country specific response
