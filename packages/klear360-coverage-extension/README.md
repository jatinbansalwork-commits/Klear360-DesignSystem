...
1. HTML, JS and CSS responsible for rendering:
   1. UI of plugin.
   2. Trigger klear360 coverage.
   3. Display klear360 coverage results.
2. Background script which is responsible for:
   1. Intercepting messages from chrome plugin
   2. Interacting with DOM and getting klear360 coverage.
...
- Run yarn build, it will generate a new folder named chrome-extension in `klear360-coverage-extension` folder.
- Open chrome://extensions.
- Enable developer mode in top right.
- Click on Load Unpacked extension and open klear360-coverage-extension/chrome-extension.
- Open `x.klear.com`
- Open klear360 coverage plugin and verify your changes.
