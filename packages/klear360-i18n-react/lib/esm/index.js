...
import { getState, setState } from '@klear/i18n/core';
...
const I18nProvider = ({ children, initData = {} }) => {
  ...
  const [i18nState, setI18nState] = useState(() => {
    const data = Object.assign(Object.assign({}, getState()), initData);
    setState(data);
    return data;
  });
  /**
  ...
  const updateI18nState = (data) => {
    ...
    setState(Object.assign(Object.assign({}, i18nState), data));
  };
  const contextValue = {
    i18nState,
